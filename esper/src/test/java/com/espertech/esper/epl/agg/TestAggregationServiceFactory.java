...
public class TestAggregationServiceFactory extends TestCase
{
    ...
    public void testGetService() throws Exception
    {
        ...
        AggregationService service = AggregationServiceFactory.getService(selectAggregateNodes, havingAggregateNodes, orderByAggregateNodes, false, methodResolutionService, null, null, null, null, false);
        assertTrue(service instanceof AggSvcGroupAllNoAccessImpl);

        // Test with aggregates and group by
        service = AggregationServiceFactory.getService(selectAggregateNodes, havingAggregateNodes, orderByAggregateNodes, true, methodResolutionService, null, null, null, null, false);
