...
public class TestExprCoalesceNode extends TestCase
{
    ...
    public void testGetType() throws Exception
    {
        ...
        {
            coalesceNodes[i].validate(null, null, null, null, null, null);
        }
    ...
    public void testValidate() throws Exception
    {
        ...
        try
        {
            coalesceNode.validate(null, null, null, null, null, null);
            fail();
        }
    ...
    {
        coalesceNodes[0].validate(null, null, null, null, null, null);
