...
public class TestJoinSetComposerFactory extends TestCase
{
    ...
    public void testBuildComposer() throws Exception
    {
        ...
        JoinSetComposerDesc desc = (new JoinSetComposerFactoryImpl()).makeComposer("ABC", "001", outerJoins, new SupportExprNode(true), streamTypes, new String[]{"a", "b", "c", "d"}, streamViewables, SelectClauseStreamSelectorEnum.RSTREAM_ISTREAM_BOTH, new StreamJoinAnalysisResult(4), null, true, null);
