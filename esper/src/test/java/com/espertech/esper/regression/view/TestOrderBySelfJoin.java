...
public class TestOrderBySelfJoin extends TestCase
{
    ...
    public void testOrderedSelfJoin()
	{
        ...
        String statementString = "select c1.event_criteria_id as ecid, " +
    	            ...
    	            SupportHierarchyEvent.class.getName() + ".std:groupby(event_criteria_id).std:lastevent() as c2, " +
    	            SupportHierarchyEvent.class.getName() + ".std:groupby(event_criteria_id).std:lastevent() as p " +
