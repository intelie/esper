...
public class TestVirtualDataWindowToLookup extends TestCase {
    ...
    public void testLateConsumerNoIterate() throws Exception {
        ...
        SubordTableLookupStrategy strategy = processor.getRootView().getAddSubqueryLookupStrategy("ABC", "001", null, spiContext.getOuterTypePerStream(), spiContext.getJoinDesc(), spiContext.isForceTableScan());
