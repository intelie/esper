...
public class TestPerfDTIntervalOps extends TestCase {
    ...
    public void testBeforeNoDurationStream() {
        ...
        config.setDurationProperty("duration");
        epService.getEPAdministrator().getConfiguration().addEventType("A", SupportTimeDurationA.class.getName(), config);
        epService.getEPAdministrator().getConfiguration().addEventType("B", SupportTimeDurationB.class.getName(), config);
        ...
        for (int i = 0; i < 10000; i++) {
            epService.getEPRuntime().sendEvent(SupportTimeDurationA.make("A" + i, "2002-05-30T9:00:00.000", 0));
        }
        epService.getEPRuntime().sendEvent(SupportTimeDurationA.make("AX", "2002-05-30T8:00:00.000", 0));
        ...
        for (int i = 0; i < 1000; i++) {
            epService.getEPRuntime().sendEvent(SupportTimeDurationB.make("B", "2002-05-30T9:00:00.000", 0));
