...
public class TestEnumTakeWhileLast extends TestCase {
    ...
    public void testTakeWhileLast() {

        String[] fields = "val0,val1".split(",");
        String epl = "select " +
                "contained.takeWhileLast(x => x.p00 > 0) as val0," +
                "contained.takeWhileLast( (x, i) => x.p00 > 0 and i<2) as val1" +
                " from Bean";
        ...
        LambdaAssertionUtil.assertST0Id(listener, "val1", "E2,E3");
        listener.reset();

        epService.getEPRuntime().sendEvent(SupportBean_ST0_Container.make2Value("E1,0", "E2,2", "E3,3"));
        LambdaAssertionUtil.assertST0Id(listener, "val0", "E2,E3");
        LambdaAssertionUtil.assertST0Id(listener, "val1", "E2,E3");
        listener.reset();
