...
public class TestBeanEventAdapter extends TestCase
{
    ...
    {
        BeanEventType eventType = beanEventTypeFactory.createBeanType("a", SupportBeanSimple.class, true);
        ...
        EventType eventTypeTwo = beanEventTypeFactory.createBeanType("b", SupportBeanSimple.class, true);
        assertTrue(eventTypeTwo == eventType);

        // Third call to create the event type, getting a given event type id
        EventType eventTypeThree = beanEventTypeFactory.createBeanType("c", SupportBeanSimple.class, true);
    ...
    public void testInterfaceProperty()
    {
        ...
        EventType typeBean = beanEventTypeFactory.createBeanType(event.getClass().getName(), event.getClass(), true);
        ...
        EventType interfaceType = beanEventTypeFactory.createBeanType("d", ISupportD.class, true);
    ...
    {
    	EventType eventType = beanEventTypeFactory.createBeanType("e", SupportBeanComplexProps.class, true);
