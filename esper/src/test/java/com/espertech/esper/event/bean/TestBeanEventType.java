...
public class TestBeanEventType extends TestCase
{
    ...
    public void testGetGetter()
    {
        ...
        try
        {
            ...
            EventType type = SupportEventAdapterService.getService().getBeanEventTypeFactory().createBeanType(Object.class.getName(), Object.class, false, false, false, null);
    ...
    public void testGetDeepSuperTypes()
    {
        ...
        ArrayAssertionUtil.assertEqualsAnyOrder(
                ...
                new EventType[] {
                    beanEventTypeFactory.createBeanType("e1", ISupportAImplSuperG.class, false, false, false, null),
                    beanEventTypeFactory.createBeanType("e2", ISupportBaseAB.class, false, false, false, null),
                    beanEventTypeFactory.createBeanType("e3", ISupportA.class, false, false, false, null),
                    beanEventTypeFactory.createBeanType("e4", ISupportB.class, false, false, false, null),
                    beanEventTypeFactory.createBeanType("e5", ISupportC.class, false, false, false, null)
                });
    }
