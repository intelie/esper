...
public class TestFilterSpecParamComparator extends TestCase
{
    ...
    public void testCompareAll()
    {
        ...
        assertEquals("[EQUAL, IN_LIST_OF_VALUES, RANGE_OPEN, RANGE_HALF_OPEN, RANGE_HALF_CLOSED, RANGE_CLOSED, LESS, LESS_OR_EQUAL, GREATER_OR_EQUAL, GREATER, NOT_RANGE_CLOSED, NOT_RANGE_HALF_CLOSED, NOT_RANGE_HALF_OPEN, NOT_RANGE_OPEN, NOT_IN_LIST_OF_VALUES, NOT_EQUAL, BOOLEAN_EXPRESSION]", sorted.toString());
