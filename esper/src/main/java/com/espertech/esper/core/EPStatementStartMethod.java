...
public class EPStatementStartMethod
{
        ...
        throws ExprValidationException, ViewProcessingException
    {
        ...
        try {
            ...
            // Materialize views
            finalView = services.getViewService().createViews(rootView, unmaterializedViewChain.getViewFactoryChain(), statementContext);
    ...
    {
        // Handle joins
        final JoinSetComposerDesc composerDesc = statementContext.getJoinSetComposerFactory().makeComposer(statementContext.getStatementName(), statementContext.getStatementId(), statementSpec.getOuterJoinDescList(), statementSpec.getFilterRootNode(), streamTypes, streamNames, streamViews, selectStreamSelectorEnum, joinAnalysisResult, statementContext, queryPlanLogging, statementContext.getAnnotations());
            ...
            if ((filterStreamSpec instanceof NamedWindowConsumerStreamSpec) && (!disableIndexShare)) {
                ...
                if (namedSpec.getFilterExpressions().isEmpty()) {
                    ...
                    if (processor.isEnableSubqueryIndexShare()) {
                        ...
                        namedWindowSubqueryLookup = processor.getRootView().getAddSubqueryLookupStrategy(statementContext.getStatementName(), statementContext.getStatementId(), statementContext.getAnnotations(), outerEventTypesSelect, joinedPropPlan, fullTableScan);
