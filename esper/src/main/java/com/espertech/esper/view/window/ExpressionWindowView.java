 ...
 */
public final class ExpressionWindowView extends ViewSupport implements DataWindowView, CloneableView
{
     ...
     */
    public ExpressionWindowView(ExpressionWindowViewFactory dataWindowViewFactory, ViewUpdatedCollection viewUpdatedCollection)
    {
    ...
    public final void update(EventBean[] newData, EventBean[] oldData)
    {
        ...
        int expiredCount = events.size() - 5;
