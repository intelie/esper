...
public final class SizeView extends ViewSupport implements CloneableView
{
    ...
    public final void update(EventBean[] newData, EventBean[] oldData)
    {
        ...
        if ((this.hasViews()) && (priorSize != size))
        {
            ...
            EventBean newEvent = statementContext.getEventAdapterService().adapterForTypedMap(postNewData, eventType);
            ...
            else
            {
                ...
                EventBean oldEvent = statementContext.getEventAdapterService().adapterForTypedMap(postOldData, eventType);
    ...
    public final Iterator<EventBean> iterator()
    {
        ...
        return new SingleEventIterator(statementContext.getEventAdapterService().adapterForTypedMap(current, eventType));
    }
