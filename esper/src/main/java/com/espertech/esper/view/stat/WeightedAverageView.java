...
public final class WeightedAverageView extends ViewSupport implements CloneableView
{
    ...
    public final void update(EventBean[] newData, EventBean[] oldData)
    {
        ...
        if (this.hasViews())
        {
            ...
            EventBean newDataEvent = statementContext.getEventAdapterService().adapterForTypedMap(newDataMap, eventType);
            ...
            if (lastNewEvent == null)
            {
                ...
                EventBean oldDataEvent = statementContext.getEventAdapterService().adapterForTypedMap(oldDataMap, eventType);
    ...
    public final Iterator<EventBean> iterator()
    {
        ...
        newDataMap.put(ViewFieldEnum.WEIGHTED_AVERAGE__AVERAGE.getName(), currentValue);
        addProperties(newDataMap);
        return new SingleEventIterator(statementContext.getEventAdapterService().adapterForTypedMap(newDataMap, eventType));
    }
