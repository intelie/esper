 ...
 */
public class PropertyIndexedEventTableSingleExpr implements EventTable
{
     ...
     */
    public PropertyIndexedEventTableSingleExpr(int streamNum, EventType eventType, String propertyName)
    {
    ...
    private static Log log = LogFactory.getLog(PropertyIndexedEventTableSingleExpr.class);
}
