 ...
 */
public class SubqIndexedTableLookupStrategySingle implements SubqTableLookupStrategy
{
     ...
     */
    public SubqIndexedTableLookupStrategySingle(EventType[] eventTypes, int keyStreamNum, String property, PropertyIndexedEventTableSingle index)
    {
    ...
    {
        return "IndexedTableLookupStrategySingle indexProps=" + property +
                " index=(" + index + ')';
    }
}
