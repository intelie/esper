...
public class NamedWindowRootView extends ViewSupport
{
            ...
            throws ExprValidationException
    {
        ...
        Pair<NamedWindowLookupStrategy,EventTable> strategy = getStrategyPair(statementContext.getStatementName(), statementContext.getStatementId(), statementContext.getAnnotations(), joinExpr, filterEventType);
