// $ANTLR 3.1.1 EsperEPL2Ast.g 2009-12-17 04:08:55
...
public class EsperEPL2Ast extends TreeParser {
    ...
    // EsperEPL2Ast.g:211:1: matchRecogMatchesAfterSkip : ^( MATCHREC_AFTER_SKIP IDENT IDENT IDENT IDENT IDENT ) ;
    public final void matchRecogMatchesAfterSkip() throws RecognitionException {
        try {
            // EsperEPL2Ast.g:212:2: ( ^( MATCHREC_AFTER_SKIP IDENT IDENT IDENT IDENT IDENT ) )
            // EsperEPL2Ast.g:212:4: ^( MATCHREC_AFTER_SKIP IDENT IDENT IDENT IDENT IDENT )
            {
            ...
            match(input,IDENT,FOLLOW_IDENT_in_matchRecogMatchesAfterSkip1129); 
            match(input,IDENT,FOLLOW_IDENT_in_matchRecogMatchesAfterSkip1131); 
    ...
    public final void matchRecogMatchesInterval() throws RecognitionException {
        try {
            ...
            {
            match(input,MATCHREC_INTERVAL,FOLLOW_MATCHREC_INTERVAL_in_matchRecogMatchesInterval1146); 

            match(input, Token.DOWN, null); 
            match(input,IDENT,FOLLOW_IDENT_in_matchRecogMatchesInterval1148); 
            pushFollow(FOLLOW_timePeriod_in_matchRecogMatchesInterval1150);
            timePeriod();
    ...
    public final void matchRecogMeasures() throws RecognitionException {
        ...
        try {
            ...
            {
            m=(CommonTree)match(input,MATCHREC_MEASURES,FOLLOW_MATCHREC_MEASURES_in_matchRecogMeasures1166); 
            ...
            if ( input.LA(1)==Token.DOWN ) {
                ...
                do {
                	...
                	case 1 :
                	    // EsperEPL2Ast.g:220:26: matchRecogMeasureListElement
                	    {
                	    pushFollow(FOLLOW_matchRecogMeasureListElement_in_matchRecogMeasures1168);
    ...
    public final void matchRecogMeasureListElement() throws RecognitionException {
        ...
        try {
            ...
            {
            m=(CommonTree)match(input,MATCHREC_MEASURE_ITEM,FOLLOW_MATCHREC_MEASURE_ITEM_in_matchRecogMeasureListElement1185); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_matchRecogMeasureListElement1187);
            valueExpr();
            ...
            switch (alt65) {
                case 1 :
                    // EsperEPL2Ast.g:224:40: IDENT
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_matchRecogMeasureListElement1189); 
    ...
    public final void matchRecogPattern() throws RecognitionException {
        ...
        try {
            ...
            {
            p=(CommonTree)match(input,MATCHREC_PATTERN,FOLLOW_MATCHREC_PATTERN_in_matchRecogPattern1209); 
            ...
            do {
            	...
            	case 1 :
            	    // EsperEPL2Ast.g:228:25: matchRecogPatternAlteration
            	    {
            	    pushFollow(FOLLOW_matchRecogPatternAlteration_in_matchRecogPattern1211);
        ...
        try {
            ...
            switch (alt68) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_matchRecogPatternConcat_in_matchRecogPatternAlteration1226);
                ...
                case 2 :
                    ...
                    {
                    o=(CommonTree)match(input,MATCHREC_PATTERN_ALTER,FOLLOW_MATCHREC_PATTERN_ALTER_in_matchRecogPatternAlteration1234); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_matchRecogPatternConcat_in_matchRecogPatternAlteration1236);
                    matchRecogPatternConcat();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    // EsperEPL2Ast.g:233:55: matchRecogPatternConcat
                    	    {
                    	    pushFollow(FOLLOW_matchRecogPatternConcat_in_matchRecogPatternAlteration1238);
                    	    matchRecogPatternConcat();
    ...
    public final void matchRecogPatternConcat() throws RecognitionException {
        ...
        try {
            ...
            {
            p=(CommonTree)match(input,MATCHREC_PATTERN_CONCAT,FOLLOW_MATCHREC_PATTERN_CONCAT_in_matchRecogPatternConcat1256); 
            ...
            do {
            	...
            	case 1 :
            	    // EsperEPL2Ast.g:237:32: matchRecogPatternUnary
            	    {
            	    pushFollow(FOLLOW_matchRecogPatternUnary_in_matchRecogPatternConcat1258);
        ...
        try {
            ...
            switch (alt70) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_matchRecogPatternNested_in_matchRecogPatternUnary1273);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_matchRecogPatternAtom_in_matchRecogPatternUnary1278);
    ...
    public final void matchRecogPatternNested() throws RecognitionException {
        ...
        try {
            ...
            {
            p=(CommonTree)match(input,MATCHREC_PATTERN_NESTED,FOLLOW_MATCHREC_PATTERN_NESTED_in_matchRecogPatternNested1293); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_matchRecogPatternAlteration_in_matchRecogPatternNested1295);
            matchRecogPatternAlteration();
    ...
    public final void matchRecogPatternAtom() throws RecognitionException {
        ...
        try {
            ...
            {
            p=(CommonTree)match(input,MATCHREC_PATTERN_ATOM,FOLLOW_MATCHREC_PATTERN_ATOM_in_matchRecogPatternAtom1326); 

            match(input, Token.DOWN, null); 
            match(input,IDENT,FOLLOW_IDENT_in_matchRecogPatternAtom1328); 
                ...
                case 1 :
                    ...
                    switch (alt72) {
                        case 1 :
                            // EsperEPL2Ast.g:250:63: QUESTION
                            {
                            match(input,QUESTION,FOLLOW_QUESTION_in_matchRecogPatternAtom1344); 
    ...
    public final void matchRecogDefine() throws RecognitionException {
        ...
        try {
            ...
            {
            p=(CommonTree)match(input,MATCHREC_DEFINE,FOLLOW_MATCHREC_DEFINE_in_matchRecogDefine1366); 
            ...
            do {
            	...
            	case 1 :
            	    // EsperEPL2Ast.g:254:24: matchRecogDefineItem
            	    {
            	    pushFollow(FOLLOW_matchRecogDefineItem_in_matchRecogDefine1368);
    ...
    public final void matchRecogDefineItem() throws RecognitionException {
        ...
        try {
            ...
            {
            d=(CommonTree)match(input,MATCHREC_DEFINE_ITEM,FOLLOW_MATCHREC_DEFINE_ITEM_in_matchRecogDefineItem1385); 

            match(input, Token.DOWN, null); 
            match(input,IDENT,FOLLOW_IDENT_in_matchRecogDefineItem1387); 
            pushFollow(FOLLOW_valueExpr_in_matchRecogDefineItem1389);
            valueExpr();
    ...
    public final void selectionList() throws RecognitionException {
        try {
            ...
            {
            pushFollow(FOLLOW_selectionListElement_in_selectionList1406);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_selectionListElement_in_selectionList1409);
            	    selectionListElement();
        ...
        try {
            ...
            switch (alt78) {
                case 1 :
                    ...
                    {
                    w=(CommonTree)match(input,WILDCARD_SELECT,FOLLOW_WILDCARD_SELECT_in_selectionListElement1425); 
                     leaveNode(w); 
                ...
                case 2 :
                    ...
                    {
                    e=(CommonTree)match(input,SELECTION_ELEMENT_EXPR,FOLLOW_SELECTION_ELEMENT_EXPR_in_selectionListElement1435); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_selectionListElement1437);
                    valueExpr();
                    ...
                    switch (alt76) {
                        case 1 :
                            ...
                            {
                            match(input,IDENT,FOLLOW_IDENT_in_selectionListElement1440); 
                ...
                case 3 :
                    ...
                    {
                    s=(CommonTree)match(input,SELECTION_STREAM,FOLLOW_SELECTION_STREAM_in_selectionListElement1454); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_selectionListElement1456); 
                    ...
                    switch (alt77) {
                        case 1 :
                            ...
                            {
                            match(input,IDENT,FOLLOW_IDENT_in_selectionListElement1459); 
    ...
    public final void outerJoin() throws RecognitionException {
        try {
            ...
            {
            pushFollow(FOLLOW_outerJoinIdent_in_outerJoin1478);
            outerJoinIdent();
        ...
        try {
            ...
            switch (alt83) {
                case 1 :
                    ...
                    {
                    tl=(CommonTree)match(input,LEFT_OUTERJOIN_EXPR,FOLLOW_LEFT_OUTERJOIN_EXPR_in_outerJoinIdent1492); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1494);
                    eventPropertyExpr(true);

                    state._fsp--;

                    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1497);
                    eventPropertyExpr(true);
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1504);
                    	    eventPropertyExpr(true);
                ...
                case 2 :
                    ...
                    {
                    tr=(CommonTree)match(input,RIGHT_OUTERJOIN_EXPR,FOLLOW_RIGHT_OUTERJOIN_EXPR_in_outerJoinIdent1519); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1521);
                    eventPropertyExpr(true);

                    state._fsp--;

                    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1524);
                    eventPropertyExpr(true);
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1531);
                    	    eventPropertyExpr(true);
                ...
                case 3 :
                    ...
                    {
                    tf=(CommonTree)match(input,FULL_OUTERJOIN_EXPR,FOLLOW_FULL_OUTERJOIN_EXPR_in_outerJoinIdent1546); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1548);
                    eventPropertyExpr(true);

                    state._fsp--;

                    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1551);
                    eventPropertyExpr(true);
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1558);
                    	    eventPropertyExpr(true);
                ...
                case 4 :
                    ...
                    {
                    i=(CommonTree)match(input,INNERJOIN_EXPR,FOLLOW_INNERJOIN_EXPR_in_outerJoinIdent1573); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1575);
                    eventPropertyExpr(true);

                    state._fsp--;

                    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1578);
                    eventPropertyExpr(true);
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    pushFollow(FOLLOW_eventPropertyExpr_in_outerJoinIdent1585);
                    	    eventPropertyExpr(true);
    ...
    public final void streamExpression() throws RecognitionException {
        ...
        try {
            ...
            {
            v=(CommonTree)match(input,STREAM_EXPR,FOLLOW_STREAM_EXPR_in_streamExpression1606); 
            ...
            switch (alt84) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_eventFilterExpr_in_streamExpression1609);
                    eventFilterExpr();
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_patternInclusionExpression_in_streamExpression1613);
                    patternInclusionExpression();
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_databaseJoinExpression_in_streamExpression1617);
                ...
                case 4 :
                    ...
                    {
                    pushFollow(FOLLOW_methodJoinExpression_in_streamExpression1621);
            ...
            switch (alt85) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_viewListExpr_in_streamExpression1625);
                    viewListExpr();
            ...
            switch (alt86) {
                case 1 :
                    ...
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_streamExpression1630); 
            ...
            switch (alt87) {
                case 1 :
                    ...
                    {
                    match(input,UNIDIRECTIONAL,FOLLOW_UNIDIRECTIONAL_in_streamExpression1635); 
    ...
    public final void eventFilterExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            f=(CommonTree)match(input,EVENT_FILTER_EXPR,FOLLOW_EVENT_FILTER_EXPR_in_eventFilterExpr1663); 
            ...
            switch (alt89) {
                case 1 :
                    // EsperEPL2Ast.g:288:27: IDENT
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_eventFilterExpr1665); 
            ...
            match(input,CLASS_IDENT,FOLLOW_CLASS_IDENT_in_eventFilterExpr1668); 
            ...
            switch (alt90) {
                case 1 :
                    // EsperEPL2Ast.g:288:46: propertyExpression
                    {
                    pushFollow(FOLLOW_propertyExpression_in_eventFilterExpr1670);
                    propertyExpression();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_eventFilterExpr1674);
            	    valueExpr();
    ...
    public final void propertyExpression() throws RecognitionException {
        try {
            ...
            {
            match(input,EVENT_FILTER_PROPERTY_EXPR,FOLLOW_EVENT_FILTER_PROPERTY_EXPR_in_propertyExpression1694); 
            ...
            if ( input.LA(1)==Token.DOWN ) {
                ...
                do {
                	...
                	case 1 :
                	    // EsperEPL2Ast.g:292:34: propertyExpressionAtom
                	    {
                	    pushFollow(FOLLOW_propertyExpressionAtom_in_propertyExpression1696);
    ...
    public final void propertyExpressionAtom() throws RecognitionException {
        ...
        try {
            ...
            {
            a=(CommonTree)match(input,EVENT_FILTER_PROPERTY_EXPR_ATOM,FOLLOW_EVENT_FILTER_PROPERTY_EXPR_ATOM_in_propertyExpressionAtom1715); 
            ...
            do {
            	...
            	case 1 :
            	    // EsperEPL2Ast.g:296:41: propertySelectionListElement
            	    {
            	    pushFollow(FOLLOW_propertySelectionListElement_in_propertyExpressionAtom1717);
            ...
            pushFollow(FOLLOW_eventPropertyExpr_in_propertyExpressionAtom1720);
            ...
            switch (alt94) {
                case 1 :
                    // EsperEPL2Ast.g:296:96: IDENT
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_propertyExpressionAtom1723); 
            ...
            match(input,WHERE_EXPR,FOLLOW_WHERE_EXPR_in_propertyExpressionAtom1727); 
            ...
            if ( input.LA(1)==Token.DOWN ) {
                ...
                switch (alt95) {
                    case 1 :
                        // EsperEPL2Ast.g:296:116: valueExpr
                        {
                        pushFollow(FOLLOW_valueExpr_in_propertyExpressionAtom1729);
                        valueExpr();
        ...
        try {
            ...
            switch (alt98) {
                case 1 :
                    ...
                    {
                    w=(CommonTree)match(input,PROPERTY_WILDCARD_SELECT,FOLLOW_PROPERTY_WILDCARD_SELECT_in_propertySelectionListElement1749); 
                     leaveNode(w); 
                ...
                case 2 :
                    ...
                    {
                    e=(CommonTree)match(input,PROPERTY_SELECTION_ELEMENT_EXPR,FOLLOW_PROPERTY_SELECTION_ELEMENT_EXPR_in_propertySelectionListElement1759); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_propertySelectionListElement1761);
                    valueExpr();
                    ...
                    switch (alt96) {
                        case 1 :
                            ...
                            {
                            match(input,IDENT,FOLLOW_IDENT_in_propertySelectionListElement1764); 
                ...
                case 3 :
                    ...
                    {
                    s=(CommonTree)match(input,PROPERTY_SELECTION_STREAM,FOLLOW_PROPERTY_SELECTION_STREAM_in_propertySelectionListElement1778); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_propertySelectionListElement1780); 
                    ...
                    switch (alt97) {
                        case 1 :
                            ...
                            {
                            match(input,IDENT,FOLLOW_IDENT_in_propertySelectionListElement1783); 
    ...
    public final void patternInclusionExpression() throws RecognitionException {
        ...
        try {
            ...
            {
            p=(CommonTree)match(input,PATTERN_INCL_EXPR,FOLLOW_PATTERN_INCL_EXPR_in_patternInclusionExpression1804); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_exprChoice_in_patternInclusionExpression1806);
            exprChoice();
    ...
    public final void databaseJoinExpression() throws RecognitionException {
        try {
            ...
            {
            match(input,DATABASE_JOIN_EXPR,FOLLOW_DATABASE_JOIN_EXPR_in_databaseJoinExpression1823); 

            match(input, Token.DOWN, null); 
            match(input,IDENT,FOLLOW_IDENT_in_databaseJoinExpression1825); 
    ...
    public final void methodJoinExpression() throws RecognitionException {
        try {
            ...
            {
            match(input,METHOD_JOIN_EXPR,FOLLOW_METHOD_JOIN_EXPR_in_methodJoinExpression1856); 

            match(input, Token.DOWN, null); 
            match(input,IDENT,FOLLOW_IDENT_in_methodJoinExpression1858); 
            match(input,CLASS_IDENT,FOLLOW_CLASS_IDENT_in_methodJoinExpression1860); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_methodJoinExpression1863);
            	    valueExpr();
    ...
    public final void viewListExpr() throws RecognitionException {
        try {
            ...
            {
            pushFollow(FOLLOW_viewExpr_in_viewListExpr1877);
            viewExpr();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_viewExpr_in_viewListExpr1880);
            	    viewExpr();
    ...
    public final void viewExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            n=(CommonTree)match(input,VIEW_EXPR,FOLLOW_VIEW_EXPR_in_viewExpr1897); 

            match(input, Token.DOWN, null); 
            match(input,IDENT,FOLLOW_IDENT_in_viewExpr1899); 
            match(input,IDENT,FOLLOW_IDENT_in_viewExpr1901); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExprWithTime_in_viewExpr1904);
            	    valueExprWithTime();
    ...
    public final void whereClause(boolean isLeaveNode) throws RecognitionException {
        ...
        try {
            ...
            {
            n=(CommonTree)match(input,WHERE_EXPR,FOLLOW_WHERE_EXPR_in_whereClause1926); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_whereClause1928);
            valueExpr();
    ...
    public final void groupByClause() throws RecognitionException {
        ...
        try {
            ...
            {
            g=(CommonTree)match(input,GROUP_BY_EXPR,FOLLOW_GROUP_BY_EXPR_in_groupByClause1946); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_groupByClause1948);
            valueExpr();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_groupByClause1951);
            	    valueExpr();
    ...
    public final void orderByClause() throws RecognitionException {
        try {
            ...
            {
            match(input,ORDER_BY_EXPR,FOLLOW_ORDER_BY_EXPR_in_orderByClause1969); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_orderByElement_in_orderByClause1971);
            orderByElement();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_orderByElement_in_orderByClause1974);
            	    orderByElement();
    ...
    public final void orderByElement() throws RecognitionException {
        ...
        try {
            ...
            {
            e=(CommonTree)match(input,ORDER_ELEMENT_EXPR,FOLLOW_ORDER_ELEMENT_EXPR_in_orderByElement1994); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_orderByElement1996);
            valueExpr();
    ...
    public final void havingClause() throws RecognitionException {
        ...
        try {
            ...
            {
            n=(CommonTree)match(input,HAVING_EXPR,FOLLOW_HAVING_EXPR_in_havingClause2021); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_havingClause2023);
            valueExpr();
        ...
        try {
            ...
            switch (alt116) {
                case 1 :
                    ...
                    {
                    e=(CommonTree)match(input,EVENT_LIMIT_EXPR,FOLLOW_EVENT_LIMIT_EXPR_in_outputLimitExpr2041); 
                    ...
                    switch (alt107) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_number_in_outputLimitExpr2055);
                            number();
                        ...
                        case 2 :
                            ...
                            {
                            match(input,IDENT,FOLLOW_IDENT_in_outputLimitExpr2057); 
                    ...
                    switch (alt108) {
                        case 1 :
                            // EsperEPL2Ast.g:346:67: outputLimitAfter
                            {
                            pushFollow(FOLLOW_outputLimitAfter_in_outputLimitExpr2060);
                            outputLimitAfter();
                ...
                case 2 :
                    ...
                    {
                    tp=(CommonTree)match(input,TIMEPERIOD_LIMIT_EXPR,FOLLOW_TIMEPERIOD_LIMIT_EXPR_in_outputLimitExpr2077); 
                    ...
                    pushFollow(FOLLOW_timePeriod_in_outputLimitExpr2090);
                    timePeriod();
                ...
                case 3 :
                    ...
                    {
                    cron=(CommonTree)match(input,CRONTAB_LIMIT_EXPR,FOLLOW_CRONTAB_LIMIT_EXPR_in_outputLimitExpr2108); 
                    ...
                    pushFollow(FOLLOW_crontabLimitParameterSet_in_outputLimitExpr2121);
                ...
                case 4 :
                    ...
                    {
                    when=(CommonTree)match(input,WHEN_LIMIT_EXPR,FOLLOW_WHEN_LIMIT_EXPR_in_outputLimitExpr2139); 
                    ...
                    pushFollow(FOLLOW_valueExpr_in_outputLimitExpr2152);
                    valueExpr();
                    ...
                    switch (alt114) {
                        case 1 :
                            // EsperEPL2Ast.g:349:67: onSetExpr
                            {
                            pushFollow(FOLLOW_onSetExpr_in_outputLimitExpr2154);
                            onSetExpr();
                    ...
                    switch (alt115) {
                        case 1 :
                            // EsperEPL2Ast.g:349:78: outputLimitAfter
                            {
                            pushFollow(FOLLOW_outputLimitAfter_in_outputLimitExpr2157);
                            outputLimitAfter();
                ...
                case 5 :
                    ...
                    {
                    after=(CommonTree)match(input,AFTER_LIMIT_EXPR,FOLLOW_AFTER_LIMIT_EXPR_in_outputLimitExpr2170); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_outputLimitAfter_in_outputLimitExpr2172);
                    outputLimitAfter();
    ...
    public final void outputLimitAfter() throws RecognitionException {
        try {
            ...
            {
            match(input,AFTER,FOLLOW_AFTER_in_outputLimitAfter2187); 
            ...
            if ( input.LA(1)==Token.DOWN ) {
                ...
                switch (alt117) {
                    case 1 :
                        // EsperEPL2Ast.g:354:12: timePeriod
                        {
                        pushFollow(FOLLOW_timePeriod_in_outputLimitAfter2189);
                        timePeriod();
                ...
                switch (alt118) {
                    case 1 :
                        // EsperEPL2Ast.g:354:24: number
                        {
                        pushFollow(FOLLOW_number_in_outputLimitAfter2192);
                        number();
    ...
    public final void rowLimitClause() throws RecognitionException {
        ...
        try {
            ...
            {
            e=(CommonTree)match(input,ROW_LIMIT_EXPR,FOLLOW_ROW_LIMIT_EXPR_in_rowLimitClause2208); 
            ...
            switch (alt119) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_number_in_rowLimitClause2211);
                    number();
                ...
                case 2 :
                    ...
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_rowLimitClause2213); 
            ...
            switch (alt120) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_number_in_rowLimitClause2217);
                    number();
                ...
                case 2 :
                    ...
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_rowLimitClause2219); 
            ...
            switch (alt121) {
                case 1 :
                    // EsperEPL2Ast.g:358:54: COMMA
                    {
                    match(input,COMMA,FOLLOW_COMMA_in_rowLimitClause2223); 
            ...
            switch (alt122) {
                case 1 :
                    // EsperEPL2Ast.g:358:61: OFFSET
                    {
                    match(input,OFFSET,FOLLOW_OFFSET_in_rowLimitClause2226); 
    ...
    public final void crontabLimitParameterSet() throws RecognitionException {
        try {
            ...
            {
            match(input,CRONTAB_LIMIT_EXPR_PARAM,FOLLOW_CRONTAB_LIMIT_EXPR_PARAM_in_crontabLimitParameterSet2244); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2246);
            valueExprWithTime();

            state._fsp--;

            pushFollow(FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2248);
            valueExprWithTime();
        ...
        try {
            ...
            switch (alt124) {
                case 1 :
                    ...
                    {
                    n=(CommonTree)match(input,LT,FOLLOW_LT_in_relationalExpr2273); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_relationalExprValue_in_relationalExpr2275);
                    relationalExprValue();
                ...
                case 2 :
                    ...
                    {
                    n=(CommonTree)match(input,GT,FOLLOW_GT_in_relationalExpr2288); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_relationalExprValue_in_relationalExpr2290);
                    relationalExprValue();
                ...
                case 3 :
                    ...
                    {
                    n=(CommonTree)match(input,LE,FOLLOW_LE_in_relationalExpr2303); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_relationalExprValue_in_relationalExpr2305);
                    relationalExprValue();
                ...
                case 4 :
                    ...
                    {
                    n=(CommonTree)match(input,GE,FOLLOW_GE_in_relationalExpr2317); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_relationalExprValue_in_relationalExpr2319);
                    relationalExprValue();
    ...
    public final void relationalExprValue() throws RecognitionException {
        try {
            ...
            {
            pushFollow(FOLLOW_valueExpr_in_relationalExprValue2341);
            valueExpr();
            ...
            switch (alt127) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_valueExpr_in_relationalExprValue2351);
                    valueExpr();
                ...
                case 2 :
                    ...
                    switch (alt126) {
                        case 1 :
                            ...
                            do {
                            	...
                            	case 1 :
                            	    // EsperEPL2Ast.g:377:22: valueExpr
                            	    {
                            	    pushFollow(FOLLOW_valueExpr_in_relationalExprValue2375);
                            	    valueExpr();
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_subSelectGroupExpr_in_relationalExprValue2380);
                            subSelectGroupExpr();
        ...
        try {
            ...
            switch (alt134) {
                case 1 :
                    ...
                    {
                    jo=(CommonTree)match(input,EVAL_OR_EXPR,FOLLOW_EVAL_OR_EXPR_in_evalExprChoice2406); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_evalExprChoice2408);
                    valueExpr();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_valueExpr_in_evalExprChoice2413);
                    	    valueExpr();
                ...
                case 2 :
                    ...
                    {
                    ja=(CommonTree)match(input,EVAL_AND_EXPR,FOLLOW_EVAL_AND_EXPR_in_evalExprChoice2427); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_evalExprChoice2429);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_valueExpr_in_evalExprChoice2431);
                    valueExpr();
                ...
                case 3 :
                    ...
                    {
                    je=(CommonTree)match(input,EVAL_EQUALS_EXPR,FOLLOW_EVAL_EQUALS_EXPR_in_evalExprChoice2448); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_evalExprChoice2450);
                    valueExpr();
                ...
                case 4 :
                    ...
                    {
                    jne=(CommonTree)match(input,EVAL_NOTEQUALS_EXPR,FOLLOW_EVAL_NOTEQUALS_EXPR_in_evalExprChoice2464); 
                ...
                case 5 :
                    ...
                    {
                    jge=(CommonTree)match(input,EVAL_EQUALS_GROUP_EXPR,FOLLOW_EVAL_EQUALS_GROUP_EXPR_in_evalExprChoice2480); 
                    ...
                    switch (alt131) {
                        case 1 :
                            ...
                            do {
                            	...
                            	case 1 :
                            	    // EsperEPL2Ast.g:387:59: valueExpr
                            	    {
                            	    pushFollow(FOLLOW_valueExpr_in_evalExprChoice2493);
                            	    valueExpr();
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_subSelectGroupExpr_in_evalExprChoice2498);
                            subSelectGroupExpr();
                ...
                case 6 :
                    ...
                    {
                    jgne=(CommonTree)match(input,EVAL_NOTEQUALS_GROUP_EXPR,FOLLOW_EVAL_NOTEQUALS_GROUP_EXPR_in_evalExprChoice2511); 
                ...
                case 7 :
                    ...
                    {
                    n=(CommonTree)match(input,NOT_EXPR,FOLLOW_NOT_EXPR_in_evalExprChoice2542); 
                ...
                case 8 :
                    ...
                    {
                    pushFollow(FOLLOW_relationalExpr_in_evalExprChoice2555);
                    relationalExpr();
        ...
        try {
            ...
            switch (alt135) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_valueExpr2568);
                    constant(true);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_substitution_in_valueExpr2574);
                    substitution();
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_arithmeticExpr_in_valueExpr2580);
                    arithmeticExpr();
                ...
                case 4 :
                    ...
                    {
                    pushFollow(FOLLOW_eventPropertyExpr_in_valueExpr2587);
                    eventPropertyExpr(true);
                ...
                case 5 :
                    ...
                    {
                    pushFollow(FOLLOW_evalExprChoice_in_valueExpr2596);
                    evalExprChoice();
                ...
                case 6 :
                    ...
                    {
                    pushFollow(FOLLOW_builtinFunc_in_valueExpr2601);
                    builtinFunc();
                ...
                case 7 :
                    ...
                    {
                    pushFollow(FOLLOW_libFunc_in_valueExpr2609);
                    libFunc();
                ...
                case 8 :
                    ...
                    {
                    pushFollow(FOLLOW_caseExpr_in_valueExpr2614);
                    caseExpr();
                ...
                case 9 :
                    ...
                    {
                    pushFollow(FOLLOW_inExpr_in_valueExpr2619);
                    inExpr();
                ...
                case 10 :
                    ...
                    {
                    pushFollow(FOLLOW_betweenExpr_in_valueExpr2625);
                    betweenExpr();
                ...
                case 11 :
                    ...
                    {
                    pushFollow(FOLLOW_likeExpr_in_valueExpr2630);
                    likeExpr();
                ...
                case 12 :
                    ...
                    {
                    pushFollow(FOLLOW_regExpExpr_in_valueExpr2635);
                    regExpExpr();
                ...
                case 13 :
                    ...
                    {
                    pushFollow(FOLLOW_arrayExpr_in_valueExpr2640);
                    arrayExpr();
                ...
                case 14 :
                    ...
                    {
                    pushFollow(FOLLOW_subSelectInExpr_in_valueExpr2645);
                    subSelectInExpr();
                ...
                case 15 :
                    ...
                    {
                    pushFollow(FOLLOW_subSelectRowExpr_in_valueExpr2651);
                    subSelectRowExpr();
                ...
                case 16 :
                    ...
                    {
                    pushFollow(FOLLOW_subSelectExistsExpr_in_valueExpr2658);
                    subSelectExistsExpr();
        ...
        try {
            ...
            switch (alt137) {
                case 1 :
                    ...
                    {
                    l=(CommonTree)match(input,LAST,FOLLOW_LAST_in_valueExprWithTime2671); 
                     leaveNode(l); 
                ...
                case 2 :
                    ...
                    {
                    lw=(CommonTree)match(input,LW,FOLLOW_LW_in_valueExprWithTime2680); 
                     leaveNode(lw); 
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_valueExpr_in_valueExprWithTime2687);
                    valueExpr();
                ...
                case 4 :
                    ...
                    {
                    ordered=(CommonTree)match(input,OBJECT_PARAM_ORDERED_EXPR,FOLLOW_OBJECT_PARAM_ORDERED_EXPR_in_valueExprWithTime2695); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_valueExprWithTime2697);
                    valueExpr();
                ...
                case 5 :
                    ...
                    {
                    pushFollow(FOLLOW_rangeOperator_in_valueExprWithTime2712);
                    rangeOperator();
                ...
                case 6 :
                    ...
                    {
                    pushFollow(FOLLOW_frequencyOperator_in_valueExprWithTime2718);
                    frequencyOperator();
                ...
                case 7 :
                    ...
                    {
                    pushFollow(FOLLOW_lastOperator_in_valueExprWithTime2723);
                    lastOperator();
                ...
                case 8 :
                    ...
                    {
                    pushFollow(FOLLOW_weekDayOperator_in_valueExprWithTime2728);
                    weekDayOperator();
                ...
                case 9 :
                    ...
                    {
                    l=(CommonTree)match(input,NUMERIC_PARAM_LIST,FOLLOW_NUMERIC_PARAM_LIST_in_valueExprWithTime2738); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    // EsperEPL2Ast.g:421:29: numericParameterList
                    	    {
                    	    pushFollow(FOLLOW_numericParameterList_in_valueExprWithTime2740);
                ...
                case 10 :
                    ...
                    {
                    s=(CommonTree)match(input,NUMBERSETSTAR,FOLLOW_NUMBERSETSTAR_in_valueExprWithTime2751); 
                     leaveNode(s); 
                ...
                case 11 :
                    ...
                    {
                    pushFollow(FOLLOW_timePeriod_in_valueExprWithTime2758);
                    timePeriod();
        ...
        try {
            ...
            switch (alt138) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_numericParameterList2771);
                    constant(true);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_rangeOperator_in_numericParameterList2778);
                    rangeOperator();
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_frequencyOperator_in_numericParameterList2784);
                    frequencyOperator();
    ...
    public final void rangeOperator() throws RecognitionException {
        ...
        try {
            ...
            {
            r=(CommonTree)match(input,NUMERIC_PARAM_RANGE,FOLLOW_NUMERIC_PARAM_RANGE_in_rangeOperator2800); 
            ...
            switch (alt139) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_rangeOperator2803);
                    constant(true);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_eventPropertyExpr_in_rangeOperator2806);
                    eventPropertyExpr(true);
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_substitution_in_rangeOperator2809);
                    substitution();
            ...
            switch (alt140) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_rangeOperator2813);
                    constant(true);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_eventPropertyExpr_in_rangeOperator2816);
                    eventPropertyExpr(true);
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_substitution_in_rangeOperator2819);
                    substitution();
    ...
    public final void frequencyOperator() throws RecognitionException {
        ...
        try {
            ...
            {
            f=(CommonTree)match(input,NUMERIC_PARAM_FREQUENCY,FOLLOW_NUMERIC_PARAM_FREQUENCY_in_frequencyOperator2840); 
            ...
            switch (alt141) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_frequencyOperator2843);
                    constant(true);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_eventPropertyExpr_in_frequencyOperator2846);
                    eventPropertyExpr(true);
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_substitution_in_frequencyOperator2849);
                    substitution();
    ...
    public final void lastOperator() throws RecognitionException {
        ...
        try {
            ...
            {
            l=(CommonTree)match(input,LAST_OPERATOR,FOLLOW_LAST_OPERATOR_in_lastOperator2868); 
            ...
            switch (alt142) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_lastOperator2871);
                    constant(true);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_eventPropertyExpr_in_lastOperator2874);
                    eventPropertyExpr(true);
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_substitution_in_lastOperator2877);
                    substitution();
    ...
    public final void weekDayOperator() throws RecognitionException {
        ...
        try {
            ...
            {
            w=(CommonTree)match(input,WEEKDAY_OPERATOR,FOLLOW_WEEKDAY_OPERATOR_in_weekDayOperator2896); 
            ...
            switch (alt143) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_weekDayOperator2899);
                    constant(true);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_eventPropertyExpr_in_weekDayOperator2902);
                    eventPropertyExpr(true);
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_substitution_in_weekDayOperator2905);
                    substitution();
    ...
    public final void subSelectGroupExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            pushStmtContext();
            s=(CommonTree)match(input,SUBSELECT_GROUP_EXPR,FOLLOW_SUBSELECT_GROUP_EXPR_in_subSelectGroupExpr2926); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_subQueryExpr_in_subSelectGroupExpr2928);
            subQueryExpr();
    ...
    public final void subSelectRowExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            pushStmtContext();
            s=(CommonTree)match(input,SUBSELECT_EXPR,FOLLOW_SUBSELECT_EXPR_in_subSelectRowExpr2947); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_subQueryExpr_in_subSelectRowExpr2949);
            subQueryExpr();
    ...
    public final void subSelectExistsExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            pushStmtContext();
            e=(CommonTree)match(input,EXISTS_SUBSELECT_EXPR,FOLLOW_EXISTS_SUBSELECT_EXPR_in_subSelectExistsExpr2968); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_subQueryExpr_in_subSelectExistsExpr2970);
            subQueryExpr();
        ...
        try {
            ...
            switch (alt144) {
                case 1 :
                    ...
                    {
                    s=(CommonTree)match(input,IN_SUBSELECT_EXPR,FOLLOW_IN_SUBSELECT_EXPR_in_subSelectInExpr2989); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_subSelectInExpr2991);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_subSelectInQueryExpr_in_subSelectInExpr2993);
                ...
                case 2 :
                    ...
                    {
                    s=(CommonTree)match(input,NOT_IN_SUBSELECT_EXPR,FOLLOW_NOT_IN_SUBSELECT_EXPR_in_subSelectInExpr3005); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_subSelectInExpr3007);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_subSelectInQueryExpr_in_subSelectInExpr3009);
                    subSelectInQueryExpr();
    ...
    public final void subSelectInQueryExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            pushStmtContext();
            i=(CommonTree)match(input,IN_SUBSELECT_QUERY_EXPR,FOLLOW_IN_SUBSELECT_QUERY_EXPR_in_subSelectInQueryExpr3028); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_subQueryExpr_in_subSelectInQueryExpr3030);
            subQueryExpr();
        ...
        try {
            ...
            switch (alt145) {
                case 1 :
                    // EsperEPL2Ast.g:470:4: DISTINCT
                    {
                    match(input,DISTINCT,FOLLOW_DISTINCT_in_subQueryExpr3046); 
            ...
            pushFollow(FOLLOW_selectionListElement_in_subQueryExpr3049);
            selectionListElement();

            state._fsp--;

            pushFollow(FOLLOW_subSelectFilterExpr_in_subQueryExpr3051);
            subSelectFilterExpr();
            ...
            switch (alt146) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_whereClause_in_subQueryExpr3054);
                    whereClause(true);
    ...
    public final void subSelectFilterExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            v=(CommonTree)match(input,STREAM_EXPR,FOLLOW_STREAM_EXPR_in_subSelectFilterExpr3072); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_eventFilterExpr_in_subSelectFilterExpr3074);
            eventFilterExpr();
            ...
            switch (alt147) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_viewListExpr_in_subSelectFilterExpr3077);
                    viewListExpr();
            ...
            switch (alt148) {
                case 1 :
                    ...
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_subSelectFilterExpr3082); 
            ...
            switch (alt149) {
                case 1 :
                    // EsperEPL2Ast.g:474:61: RETAINUNION
                    {
                    match(input,RETAINUNION,FOLLOW_RETAINUNION_in_subSelectFilterExpr3086); 
            ...
            switch (alt150) {
                case 1 :
                    // EsperEPL2Ast.g:474:74: RETAININTERSECTION
                    {
                    match(input,RETAININTERSECTION,FOLLOW_RETAININTERSECTION_in_subSelectFilterExpr3089); 
        ...
        try {
            ...
            switch (alt153) {
                case 1 :
                    ...
                    {
                    c=(CommonTree)match(input,CASE,FOLLOW_CASE_in_caseExpr3109); 
                    ...
                    if ( input.LA(1)==Token.DOWN ) {
                        ...
                        do {
                        	...
                        	case 1 :
                        	    ...
                        	    {
                        	    pushFollow(FOLLOW_valueExpr_in_caseExpr3112);
                        	    valueExpr();
                ...
                case 2 :
                    ...
                    {
                    c=(CommonTree)match(input,CASE2,FOLLOW_CASE2_in_caseExpr3125); 
                    ...
                    if ( input.LA(1)==Token.DOWN ) {
                        ...
                        do {
                        	...
                        	case 1 :
                        	    ...
                        	    {
                        	    pushFollow(FOLLOW_valueExpr_in_caseExpr3128);
                        	    valueExpr();
        ...
        try {
            ...
            switch (alt156) {
                case 1 :
                    ...
                    {
                    i=(CommonTree)match(input,IN_SET,FOLLOW_IN_SET_in_inExpr3148); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_inExpr3150);
                    valueExpr();
                    ...
                    pushFollow(FOLLOW_valueExpr_in_inExpr3158);
                    valueExpr();
                ...
                case 2 :
                    ...
                    {
                    i=(CommonTree)match(input,NOT_IN_SET,FOLLOW_NOT_IN_SET_in_inExpr3180); 
                ...
                case 3 :
                    ...
                    {
                    i=(CommonTree)match(input,IN_RANGE,FOLLOW_IN_RANGE_in_inExpr3212); 
                ...
                case 4 :
                    ...
                    {
                    i=(CommonTree)match(input,NOT_IN_RANGE,FOLLOW_NOT_IN_RANGE_in_inExpr3241); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_inExpr3243);
                    valueExpr();
                    ...
                    pushFollow(FOLLOW_valueExpr_in_inExpr3251);
                    valueExpr();
        ...
        try {
            ...
            switch (alt158) {
                case 1 :
                    ...
                    {
                    b=(CommonTree)match(input,BETWEEN,FOLLOW_BETWEEN_in_betweenExpr3278); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_betweenExpr3280);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_valueExpr_in_betweenExpr3282);
                    valueExpr();
                ...
                case 2 :
                    ...
                    {
                    b=(CommonTree)match(input,NOT_BETWEEN,FOLLOW_NOT_BETWEEN_in_betweenExpr3295); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_betweenExpr3297);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_valueExpr_in_betweenExpr3299);
                    valueExpr();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_valueExpr_in_betweenExpr3302);
                    	    valueExpr();
        ...
        try {
            ...
            switch (alt161) {
                case 1 :
                    ...
                    {
                    l=(CommonTree)match(input,LIKE,FOLLOW_LIKE_in_likeExpr3322); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_likeExpr3324);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_valueExpr_in_likeExpr3326);
                    valueExpr();
                    ...
                    switch (alt159) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_valueExpr_in_likeExpr3329);
                            valueExpr();
                ...
                case 2 :
                    ...
                    {
                    l=(CommonTree)match(input,NOT_LIKE,FOLLOW_NOT_LIKE_in_likeExpr3342); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_likeExpr3344);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_valueExpr_in_likeExpr3346);
                    valueExpr();
                    ...
                    switch (alt160) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_valueExpr_in_likeExpr3349);
                            valueExpr();
        ...
        try {
            ...
            switch (alt162) {
                case 1 :
                    ...
                    {
                    r=(CommonTree)match(input,REGEXP,FOLLOW_REGEXP_in_regExpExpr3368); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_regExpExpr3370);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_valueExpr_in_regExpExpr3372);
                    valueExpr();
                ...
                case 2 :
                    ...
                    {
                    r=(CommonTree)match(input,NOT_REGEXP,FOLLOW_NOT_REGEXP_in_regExpExpr3383); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_regExpExpr3385);
                    valueExpr();

                    state._fsp--;

                    pushFollow(FOLLOW_valueExpr_in_regExpExpr3387);
                    valueExpr();
        ...
        try {
            ...
            switch (alt175) {
                case 1 :
                    ...
                    {
                    f=(CommonTree)match(input,SUM,FOLLOW_SUM_in_builtinFunc3406); 
                    ...
                    switch (alt163) {
                        case 1 :
                            ...
                            {
                            match(input,DISTINCT,FOLLOW_DISTINCT_in_builtinFunc3409); 
                    ...
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3413);
                    valueExpr();
                ...
                case 2 :
                    ...
                    {
                    f=(CommonTree)match(input,AVG,FOLLOW_AVG_in_builtinFunc3424); 
                    ...
                    switch (alt164) {
                        case 1 :
                            ...
                            {
                            match(input,DISTINCT,FOLLOW_DISTINCT_in_builtinFunc3427); 
                    ...
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3431);
                    valueExpr();
                ...
                case 3 :
                    ...
                    {
                    f=(CommonTree)match(input,COUNT,FOLLOW_COUNT_in_builtinFunc3442); 
                            ...
                            case 1 :
                                ...
                                switch (alt165) {
                                    case 1 :
                                        ...
                                        {
                                        match(input,DISTINCT,FOLLOW_DISTINCT_in_builtinFunc3446); 
                ...
                case 4 :
                    ...
                    {
                    f=(CommonTree)match(input,MEDIAN,FOLLOW_MEDIAN_in_builtinFunc3464); 
                    ...
                    switch (alt167) {
                        case 1 :
                            ...
                            {
                            match(input,DISTINCT,FOLLOW_DISTINCT_in_builtinFunc3467); 
                    ...
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3471);
                    valueExpr();
                ...
                case 5 :
                    ...
                    {
                    f=(CommonTree)match(input,STDDEV,FOLLOW_STDDEV_in_builtinFunc3482); 
                    ...
                    switch (alt168) {
                        case 1 :
                            ...
                            {
                            match(input,DISTINCT,FOLLOW_DISTINCT_in_builtinFunc3485); 
                ...
                case 6 :
                    ...
                    {
                    f=(CommonTree)match(input,AVEDEV,FOLLOW_AVEDEV_in_builtinFunc3500); 
                    ...
                    switch (alt169) {
                        case 1 :
                            ...
                            {
                            match(input,DISTINCT,FOLLOW_DISTINCT_in_builtinFunc3503); 
                    ...
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3507);
                    valueExpr();
                ...
                case 7 :
                    ...
                    {
                    f=(CommonTree)match(input,LAST_AGGREG,FOLLOW_LAST_AGGREG_in_builtinFunc3518); 
                    ...
                    switch (alt170) {
                        case 1 :
                            ...
                            {
                            match(input,DISTINCT,FOLLOW_DISTINCT_in_builtinFunc3521); 
                    ...
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3525);
                    valueExpr();
                ...
                case 8 :
                    ...
                    {
                    f=(CommonTree)match(input,FIRST_AGGREG,FOLLOW_FIRST_AGGREG_in_builtinFunc3536); 
                    ...
                    switch (alt171) {
                        case 1 :
                            ...
                            {
                            match(input,DISTINCT,FOLLOW_DISTINCT_in_builtinFunc3539); 
                    ...
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3543);
                    valueExpr();
                ...
                case 9 :
                    ...
                    {
                    f=(CommonTree)match(input,COALESCE,FOLLOW_COALESCE_in_builtinFunc3555); 
                    ...
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3559);
                    valueExpr();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_valueExpr_in_builtinFunc3562);
                    	    valueExpr();
                ...
                case 10 :
                    ...
                    {
                    f=(CommonTree)match(input,PREVIOUS,FOLLOW_PREVIOUS_in_builtinFunc3577); 
                    ...
                    switch (alt173) {
                        case 1 :
                            // EsperEPL2Ast.g:514:28: valueExpr
                            {
                            pushFollow(FOLLOW_valueExpr_in_builtinFunc3581);
                            valueExpr();
                ...
                case 11 :
                    ...
                    {
                    f=(CommonTree)match(input,PRIOR,FOLLOW_PRIOR_in_builtinFunc3594); 

                    match(input, Token.DOWN, null); 
                    c=(CommonTree)match(input,NUM_INT,FOLLOW_NUM_INT_in_builtinFunc3598); 
                    pushFollow(FOLLOW_eventPropertyExpr_in_builtinFunc3600);
                    eventPropertyExpr(true);
                ...
                case 12 :
                    ...
                    {
                    f=(CommonTree)match(input,INSTANCEOF,FOLLOW_INSTANCEOF_in_builtinFunc3613); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3615);
                    valueExpr();

                    state._fsp--;

                    match(input,CLASS_IDENT,FOLLOW_CLASS_IDENT_in_builtinFunc3617); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    match(input,CLASS_IDENT,FOLLOW_CLASS_IDENT_in_builtinFunc3620); 
                ...
                case 13 :
                    ...
                    {
                    f=(CommonTree)match(input,CAST,FOLLOW_CAST_in_builtinFunc3634); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_builtinFunc3636);
                    valueExpr();

                    state._fsp--;

                    match(input,CLASS_IDENT,FOLLOW_CLASS_IDENT_in_builtinFunc3638); 
                ...
                case 14 :
                    ...
                    {
                    f=(CommonTree)match(input,EXISTS,FOLLOW_EXISTS_in_builtinFunc3650); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_eventPropertyExpr_in_builtinFunc3652);
                    eventPropertyExpr(true);
                ...
                case 15 :
                    ...
                    {
                    f=(CommonTree)match(input,CURRENT_TIMESTAMP,FOLLOW_CURRENT_TIMESTAMP_in_builtinFunc3664); 
    ...
    public final void arrayExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            a=(CommonTree)match(input,ARRAY_EXPR,FOLLOW_ARRAY_EXPR_in_arrayExpr3684); 
            ...
            if ( input.LA(1)==Token.DOWN ) {
                ...
                do {
                	...
                	case 1 :
                	    ...
                	    {
                	    pushFollow(FOLLOW_valueExpr_in_arrayExpr3687);
                	    valueExpr();
        ...
        try {
            ...
            switch (alt178) {
                case 1 :
                    ...
                    {
                    a=(CommonTree)match(input,PLUS,FOLLOW_PLUS_in_arithmeticExpr3708); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_arithmeticExpr3710);
                    valueExpr();
                ...
                case 2 :
                    ...
                    {
                    a=(CommonTree)match(input,MINUS,FOLLOW_MINUS_in_arithmeticExpr3724); 
                ...
                case 3 :
                    ...
                    {
                    a=(CommonTree)match(input,DIV,FOLLOW_DIV_in_arithmeticExpr3740); 
                ...
                case 4 :
                    ...
                    {
                    a=(CommonTree)match(input,STAR,FOLLOW_STAR_in_arithmeticExpr3755); 
                ...
                case 5 :
                    ...
                    {
                    a=(CommonTree)match(input,MOD,FOLLOW_MOD_in_arithmeticExpr3771); 
                ...
                case 6 :
                    ...
                    {
                    a=(CommonTree)match(input,BAND,FOLLOW_BAND_in_arithmeticExpr3786); 
                ...
                case 7 :
                    ...
                    {
                    a=(CommonTree)match(input,BOR,FOLLOW_BOR_in_arithmeticExpr3801); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_arithmeticExpr3803);
                    valueExpr();
                ...
                case 8 :
                    ...
                    {
                    a=(CommonTree)match(input,BXOR,FOLLOW_BXOR_in_arithmeticExpr3816); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_valueExpr_in_arithmeticExpr3818);
                    valueExpr();
                ...
                case 9 :
                    ...
                    {
                    a=(CommonTree)match(input,CONCAT,FOLLOW_CONCAT_in_arithmeticExpr3832); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_valueExpr_in_arithmeticExpr3839);
                    	    valueExpr();
    ...
    public final void libFunc() throws RecognitionException {
        ...
        try {
            ...
            {
            l=(CommonTree)match(input,LIB_FUNCTION,FOLLOW_LIB_FUNCTION_in_libFunc3860); 
            ...
            switch (alt179) {
                case 1 :
                    ...
                    {
                    match(input,CLASS_IDENT,FOLLOW_CLASS_IDENT_in_libFunc3863); 
            ...
            match(input,IDENT,FOLLOW_IDENT_in_libFunc3867); 
            ...
            switch (alt180) {
                case 1 :
                    ...
                    {
                    match(input,DISTINCT,FOLLOW_DISTINCT_in_libFunc3870); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_libFunc3875);
            	    valueExpr();
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    // EsperEPL2Ast.g:546:4: annotation[true]
            	    {
            	    pushFollow(FOLLOW_annotation_in_startPatternExpressionRule3895);
            	    annotation(true);
            ...
            pushFollow(FOLLOW_exprChoice_in_startPatternExpressionRule3899);
            exprChoice();
        ...
        try {
            ...
            switch (alt186) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_atomicExpr_in_exprChoice3913);
                    atomicExpr();
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_patternOp_in_exprChoice3918);
                    patternOp();
                ...
                case 3 :
                    ...
                    {
                    a=(CommonTree)match(input,EVERY_EXPR,FOLLOW_EVERY_EXPR_in_exprChoice3928); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_exprChoice_in_exprChoice3930);
                    exprChoice();
                ...
                case 4 :
                    ...
                    {
                    a=(CommonTree)match(input,EVERY_DISTINCT_EXPR,FOLLOW_EVERY_DISTINCT_EXPR_in_exprChoice3944); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_distinctExpressions_in_exprChoice3946);
                    distinctExpressions();

                    state._fsp--;

                    pushFollow(FOLLOW_exprChoice_in_exprChoice3948);
                    exprChoice();
                ...
                case 5 :
                    ...
                    {
                    n=(CommonTree)match(input,PATTERN_NOT_EXPR,FOLLOW_PATTERN_NOT_EXPR_in_exprChoice3962); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_exprChoice_in_exprChoice3964);
                    exprChoice();
                ...
                case 6 :
                    ...
                    {
                    g=(CommonTree)match(input,GUARD_EXPR,FOLLOW_GUARD_EXPR_in_exprChoice3978); 
                    ...
                    match(input,IDENT,FOLLOW_IDENT_in_exprChoice3982); 
                    match(input,IDENT,FOLLOW_IDENT_in_exprChoice3984); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    // EsperEPL2Ast.g:555:44: valueExprWithTime
                    	    {
                    	    pushFollow(FOLLOW_valueExprWithTime_in_exprChoice3986);
                    	    valueExprWithTime();
                ...
                case 7 :
                    ...
                    {
                    m=(CommonTree)match(input,MATCH_UNTIL_EXPR,FOLLOW_MATCH_UNTIL_EXPR_in_exprChoice4000); 
                    ...
                    switch (alt184) {
                        case 1 :
                            // EsperEPL2Ast.g:556:26: matchUntilRange
                            {
                            pushFollow(FOLLOW_matchUntilRange_in_exprChoice4002);
                            matchUntilRange();
                    ...
                    pushFollow(FOLLOW_exprChoice_in_exprChoice4005);
                    exprChoice();
                    ...
                    switch (alt185) {
                        case 1 :
                            // EsperEPL2Ast.g:556:54: exprChoice
                            {
                            pushFollow(FOLLOW_exprChoice_in_exprChoice4007);
                            exprChoice();
    ...
    public final void distinctExpressions() throws RecognitionException {
        try {
            ...
            {
            match(input,PATTERN_EVERY_DISTINCT_EXPR,FOLLOW_PATTERN_EVERY_DISTINCT_EXPR_in_distinctExpressions4028); 
            ...
            do {
            	...
            	case 1 :
            	    // EsperEPL2Ast.g:561:35: valueExpr
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_distinctExpressions4030);
            	    valueExpr();
        ...
        try {
            ...
            switch (alt191) {
                case 1 :
                    ...
                    {
                    f=(CommonTree)match(input,FOLLOWED_BY_EXPR,FOLLOW_FOLLOWED_BY_EXPR_in_patternOp4049); 
                    ...
                    pushFollow(FOLLOW_exprChoice_in_patternOp4053);
                    exprChoice();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_exprChoice_in_patternOp4056);
                    	    exprChoice();
                ...
                case 2 :
                    ...
                    {
                    o=(CommonTree)match(input,OR_EXPR,FOLLOW_OR_EXPR_in_patternOp4072); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_exprChoice_in_patternOp4074);
                    exprChoice();

                    state._fsp--;

                    pushFollow(FOLLOW_exprChoice_in_patternOp4076);
                    exprChoice();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_exprChoice_in_patternOp4079);
                    	    exprChoice();
                ...
                case 3 :
                    ...
                    {
                    a=(CommonTree)match(input,AND_EXPR,FOLLOW_AND_EXPR_in_patternOp4095); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_exprChoice_in_patternOp4097);
                    exprChoice();

                    state._fsp--;

                    pushFollow(FOLLOW_exprChoice_in_patternOp4099);
                    exprChoice();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_exprChoice_in_patternOp4102);
                    	    exprChoice();
        ...
        try {
            ...
            switch (alt193) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_patternFilterExpr_in_atomicExpr4121);
                    patternFilterExpr();
                ...
                case 2 :
                    ...
                    {
                    ac=(CommonTree)match(input,OBSERVER_EXPR,FOLLOW_OBSERVER_EXPR_in_atomicExpr4133); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_atomicExpr4135); 
                    match(input,IDENT,FOLLOW_IDENT_in_atomicExpr4137); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    // EsperEPL2Ast.g:572:39: valueExprWithTime
                    	    {
                    	    pushFollow(FOLLOW_valueExprWithTime_in_atomicExpr4139);
                    	    valueExprWithTime();
    ...
    public final void patternFilterExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            f=(CommonTree)match(input,PATTERN_FILTER_EXPR,FOLLOW_PATTERN_FILTER_EXPR_in_patternFilterExpr4159); 
            ...
            switch (alt194) {
                case 1 :
                    // EsperEPL2Ast.g:576:29: IDENT
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_patternFilterExpr4161); 
            ...
            match(input,CLASS_IDENT,FOLLOW_CLASS_IDENT_in_patternFilterExpr4164); 
            ...
            switch (alt195) {
                case 1 :
                    // EsperEPL2Ast.g:576:48: propertyExpression
                    {
                    pushFollow(FOLLOW_propertyExpression_in_patternFilterExpr4166);
                    propertyExpression();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_patternFilterExpr4170);
            	    valueExpr();
        ...
        try {
            ...
            switch (alt197) {
                case 1 :
                    ...
                    {
                    match(input,MATCH_UNTIL_RANGE_CLOSED,FOLLOW_MATCH_UNTIL_RANGE_CLOSED_in_matchUntilRange4188); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4190);
                    matchUntilRangeParam();

                    state._fsp--;

                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4192);
                    matchUntilRangeParam();
                ...
                case 2 :
                    ...
                    {
                    match(input,MATCH_UNTIL_RANGE_BOUNDED,FOLLOW_MATCH_UNTIL_RANGE_BOUNDED_in_matchUntilRange4200); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4202);
                    matchUntilRangeParam();
                ...
                case 3 :
                    ...
                    {
                    match(input,MATCH_UNTIL_RANGE_HALFCLOSED,FOLLOW_MATCH_UNTIL_RANGE_HALFCLOSED_in_matchUntilRange4210); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4212);
                    matchUntilRangeParam();
                ...
                case 4 :
                    ...
                    {
                    match(input,MATCH_UNTIL_RANGE_HALFOPEN,FOLLOW_MATCH_UNTIL_RANGE_HALFOPEN_in_matchUntilRange4219); 
    ...
    public final void filterParam() throws RecognitionException {
        try {
            ...
            {
            match(input,EVENT_FILTER_PARAM,FOLLOW_EVENT_FILTER_PARAM_in_filterParam4250); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_filterParam4252);
            valueExpr();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_filterParam4255);
            	    valueExpr();
        ...
        try {
            ...
            switch (alt211) {
                case 1 :
                    ...
                    {
                    match(input,EQUALS,FOLLOW_EQUALS_in_filterParamComparator4271); 
                ...
                case 2 :
                    ...
                    {
                    match(input,NOT_EQUAL,FOLLOW_NOT_EQUAL_in_filterParamComparator4280); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4282);
                    filterAtom();
                ...
                case 3 :
                    ...
                    {
                    match(input,LT,FOLLOW_LT_in_filterParamComparator4289); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4291);
                    filterAtom();
                ...
                case 4 :
                    ...
                    {
                    match(input,LE,FOLLOW_LE_in_filterParamComparator4298); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4300);
                    filterAtom();
                ...
                case 5 :
                    ...
                    {
                    match(input,GT,FOLLOW_GT_in_filterParamComparator4307); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4309);
                    filterAtom();
                ...
                case 6 :
                    ...
                    {
                    match(input,GE,FOLLOW_GE_in_filterParamComparator4316); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4318);
                    filterAtom();
                ...
                case 7 :
                    ...
                    {
                    match(input,EVENT_FILTER_RANGE,FOLLOW_EVENT_FILTER_RANGE_in_filterParamComparator4325); 
                    ...
                    switch (alt200) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4341);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4344);
                            filterIdentifier();
                ...
                case 8 :
                    ...
                    {
                    match(input,EVENT_FILTER_NOT_RANGE,FOLLOW_EVENT_FILTER_NOT_RANGE_in_filterParamComparator4358); 
                    ...
                    switch (alt201) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4367);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4370);
                            filterIdentifier();
                    ...
                    switch (alt202) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4374);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4377);
                            filterIdentifier();
                ...
                case 9 :
                    ...
                    {
                    match(input,EVENT_FILTER_IN,FOLLOW_EVENT_FILTER_IN_in_filterParamComparator4391); 
                    ...
                    switch (alt203) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4400);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4403);
                            filterIdentifier();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_constant_in_filterParamComparator4407);
                    	    constant(false);
                    	...
                    	case 2 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4410);
                    	    filterIdentifier();
                ...
                case 10 :
                    ...
                    {
                    match(input,EVENT_FILTER_NOT_IN,FOLLOW_EVENT_FILTER_NOT_IN_in_filterParamComparator4425); 
                    ...
                    switch (alt205) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4434);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4437);
                            filterIdentifier();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_constant_in_filterParamComparator4441);
                    	    constant(false);
                    	...
                    	case 2 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4444);
                    	    filterIdentifier();
                ...
                case 11 :
                    ...
                    {
                    match(input,EVENT_FILTER_BETWEEN,FOLLOW_EVENT_FILTER_BETWEEN_in_filterParamComparator4459); 
                    ...
                    switch (alt207) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4462);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4465);
                            filterIdentifier();
                    ...
                    switch (alt208) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4469);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4472);
                            filterIdentifier();
                ...
                case 12 :
                    ...
                    {
                    match(input,EVENT_FILTER_NOT_BETWEEN,FOLLOW_EVENT_FILTER_NOT_BETWEEN_in_filterParamComparator4480); 
        ...
        try {
            ...
            switch (alt212) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_filterAtom4507);
                    constant(false);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_filterIdentifier_in_filterAtom4513);
                    filterIdentifier();
    ...
    public final void filterIdentifier() throws RecognitionException {
        try {
            ...
            {
            match(input,EVENT_FILTER_IDENT,FOLLOW_EVENT_FILTER_IDENT_in_filterIdentifier4524); 

            match(input, Token.DOWN, null); 
            match(input,IDENT,FOLLOW_IDENT_in_filterIdentifier4526); 
            pushFollow(FOLLOW_eventPropertyExpr_in_filterIdentifier4528);
            eventPropertyExpr(true);
    ...
    public final void eventPropertyExpr(boolean isLeaveNode) throws RecognitionException {
        ...
        try {
            ...
            {
            p=(CommonTree)match(input,EVENT_PROP_EXPR,FOLLOW_EVENT_PROP_EXPR_in_eventPropertyExpr4547); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_eventPropertyAtomic_in_eventPropertyExpr4549);
            eventPropertyAtomic();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_eventPropertyAtomic_in_eventPropertyExpr4552);
            	    eventPropertyAtomic();
        ...
        try {
            ...
            switch (alt214) {
                case 1 :
                    ...
                    {
                    match(input,EVENT_PROP_SIMPLE,FOLLOW_EVENT_PROP_SIMPLE_in_eventPropertyAtomic4571); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4573); 
                ...
                case 2 :
                    ...
                    {
                    match(input,EVENT_PROP_INDEXED,FOLLOW_EVENT_PROP_INDEXED_in_eventPropertyAtomic4580); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4582); 
                    match(input,NUM_INT,FOLLOW_NUM_INT_in_eventPropertyAtomic4584); 
                ...
                case 3 :
                    ...
                    {
                    match(input,EVENT_PROP_MAPPED,FOLLOW_EVENT_PROP_MAPPED_in_eventPropertyAtomic4591); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4593); 
                    if ( (input.LA(1)>=STRING_LITERAL && input.LA(1)<=QUOTED_STRING_LITERAL) ) {
                        input.consume();
                        state.errorRecovery=false;
                    }
                ...
                case 4 :
                    ...
                    {
                    match(input,EVENT_PROP_DYNAMIC_SIMPLE,FOLLOW_EVENT_PROP_DYNAMIC_SIMPLE_in_eventPropertyAtomic4608); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4610); 
                ...
                case 5 :
                    ...
                    {
                    match(input,EVENT_PROP_DYNAMIC_INDEXED,FOLLOW_EVENT_PROP_DYNAMIC_INDEXED_in_eventPropertyAtomic4617); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4619); 
                    match(input,NUM_INT,FOLLOW_NUM_INT_in_eventPropertyAtomic4621); 
                ...
                case 6 :
                    ...
                    {
                    match(input,EVENT_PROP_DYNAMIC_MAPPED,FOLLOW_EVENT_PROP_DYNAMIC_MAPPED_in_eventPropertyAtomic4628); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4630); 
                    if ( (input.LA(1)>=STRING_LITERAL && input.LA(1)<=QUOTED_STRING_LITERAL) ) {
                        input.consume();
                        state.errorRecovery=false;
                    }
    ...
    public final void timePeriod() throws RecognitionException {
        ...
        try {
            ...
            {
            t=(CommonTree)match(input,TIME_PERIOD,FOLLOW_TIME_PERIOD_in_timePeriod4657); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_timePeriodDef_in_timePeriod4659);
            timePeriodDef();
        ...
        try {
            ...
            switch (alt225) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_dayPart_in_timePeriodDef4675);
                    dayPart();
                    ...
                    switch (alt215) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_hourPart_in_timePeriodDef4678);
                            hourPart();
                    ...
                    switch (alt216) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_minutePart_in_timePeriodDef4683);
                            minutePart();
                    ...
                    switch (alt217) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_secondPart_in_timePeriodDef4688);
                            secondPart();
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_hourPart_in_timePeriodDef4700);
                    hourPart();
                    ...
                    switch (alt219) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_minutePart_in_timePeriodDef4703);
                            minutePart();
                    ...
                    switch (alt220) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_secondPart_in_timePeriodDef4708);
                            secondPart();
                    ...
                    switch (alt221) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_millisecondPart_in_timePeriodDef4713);
                            millisecondPart();
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_minutePart_in_timePeriodDef4720);
                    minutePart();
                    ...
                    switch (alt222) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_secondPart_in_timePeriodDef4723);
                            secondPart();
                    ...
                    switch (alt223) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_millisecondPart_in_timePeriodDef4728);
                            millisecondPart();
                ...
                case 4 :
                    ...
                    {
                    pushFollow(FOLLOW_secondPart_in_timePeriodDef4735);
                    secondPart();
                    ...
                    switch (alt224) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_millisecondPart_in_timePeriodDef4738);
                            millisecondPart();
    ...
    public final void dayPart() throws RecognitionException {
        try {
            ...
            {
            match(input,DAY_PART,FOLLOW_DAY_PART_in_dayPart4759); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_dayPart4761);
            valueExpr();
    ...
    public final void hourPart() throws RecognitionException {
        try {
            ...
            {
            match(input,HOUR_PART,FOLLOW_HOUR_PART_in_hourPart4776); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_hourPart4778);
            valueExpr();
    ...
    public final void minutePart() throws RecognitionException {
        try {
            ...
            {
            match(input,MINUTE_PART,FOLLOW_MINUTE_PART_in_minutePart4793); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_minutePart4795);
            valueExpr();
    ...
    public final void secondPart() throws RecognitionException {
        try {
            ...
            {
            match(input,SECOND_PART,FOLLOW_SECOND_PART_in_secondPart4810); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_secondPart4812);
            valueExpr();
    ...
    public final void millisecondPart() throws RecognitionException {
        try {
            ...
            {
            match(input,MILLISECOND_PART,FOLLOW_MILLISECOND_PART_in_millisecondPart4827); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_millisecondPart4829);
            valueExpr();
    ...
    public final void substitution() throws RecognitionException {
        ...
        try {
            ...
            {
            s=(CommonTree)match(input,SUBSTITUTION,FOLLOW_SUBSTITUTION_in_substitution4844); 
             leaveNode(s); 
        ...
        try {
            ...
            switch (alt226) {
                case 1 :
                    ...
                    {
                    c=(CommonTree)match(input,INT_TYPE,FOLLOW_INT_TYPE_in_constant4860); 
                ...
                case 2 :
                    ...
                    {
                    c=(CommonTree)match(input,LONG_TYPE,FOLLOW_LONG_TYPE_in_constant4869); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 3 :
                    ...
                    {
                    c=(CommonTree)match(input,FLOAT_TYPE,FOLLOW_FLOAT_TYPE_in_constant4878); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 4 :
                    ...
                    {
                    c=(CommonTree)match(input,DOUBLE_TYPE,FOLLOW_DOUBLE_TYPE_in_constant4887); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 5 :
                    ...
                    {
                    c=(CommonTree)match(input,STRING_TYPE,FOLLOW_STRING_TYPE_in_constant4903); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 6 :
                    ...
                    {
                    c=(CommonTree)match(input,BOOL_TYPE,FOLLOW_BOOL_TYPE_in_constant4919); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 7 :
                    ...
                    {
                    c=(CommonTree)match(input,NULL_TYPE,FOLLOW_NULL_TYPE_in_constant4932); 
                     if (isLeaveNode) leaveNode(c); 
    ...
    public static final BitSet FOLLOW_IDENT_in_matchRecogMatchesAfterSkip1127 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_matchRecogMatchesAfterSkip1129 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_matchRecogMatchesAfterSkip1131 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCHREC_INTERVAL_in_matchRecogMatchesInterval1146 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_matchRecogMatchesInterval1148 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000800000000000L});
    public static final BitSet FOLLOW_timePeriod_in_matchRecogMatchesInterval1150 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCHREC_MEASURES_in_matchRecogMeasures1166 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchRecogMeasureListElement_in_matchRecogMeasures1168 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0400000000000000L});
    public static final BitSet FOLLOW_MATCHREC_MEASURE_ITEM_in_matchRecogMeasureListElement1185 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_matchRecogMeasureListElement1187 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_matchRecogMeasureListElement1189 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCHREC_PATTERN_in_matchRecogPattern1209 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchRecogPatternAlteration_in_matchRecogPattern1211 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x000C000000000000L});
    public static final BitSet FOLLOW_matchRecogPatternConcat_in_matchRecogPatternAlteration1226 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MATCHREC_PATTERN_ALTER_in_matchRecogPatternAlteration1234 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchRecogPatternConcat_in_matchRecogPatternAlteration1236 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0004000000000000L});
    public static final BitSet FOLLOW_matchRecogPatternConcat_in_matchRecogPatternAlteration1238 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0004000000000000L});
    public static final BitSet FOLLOW_MATCHREC_PATTERN_CONCAT_in_matchRecogPatternConcat1256 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchRecogPatternUnary_in_matchRecogPatternConcat1258 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0012000000000000L});
    public static final BitSet FOLLOW_matchRecogPatternNested_in_matchRecogPatternUnary1273 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_matchRecogPatternAtom_in_matchRecogPatternUnary1278 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MATCHREC_PATTERN_NESTED_in_matchRecogPatternNested1293 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchRecogPatternAlteration_in_matchRecogPatternNested1295 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000034L});
    public static final BitSet FOLLOW_set_in_matchRecogPatternNested1297 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCHREC_PATTERN_ATOM_in_matchRecogPatternAtom1326 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_matchRecogPatternAtom1328 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000034L});
    public static final BitSet FOLLOW_set_in_matchRecogPatternAtom1332 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_QUESTION_in_matchRecogPatternAtom1344 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCHREC_DEFINE_in_matchRecogDefine1366 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchRecogDefineItem_in_matchRecogDefine1368 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0100000000000000L});
    public static final BitSet FOLLOW_MATCHREC_DEFINE_ITEM_in_matchRecogDefineItem1385 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_matchRecogDefineItem1387 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_matchRecogDefineItem1389 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_selectionListElement_in_selectionList1406 = new BitSet(new long[]{0x0000400000000002L,0x0000000000000000L,0x20000000000C0000L});
    public static final BitSet FOLLOW_selectionListElement_in_selectionList1409 = new BitSet(new long[]{0x0000400000000002L,0x0000000000000000L,0x20000000000C0000L});
    public static final BitSet FOLLOW_WILDCARD_SELECT_in_selectionListElement1425 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SELECTION_ELEMENT_EXPR_in_selectionListElement1435 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_selectionListElement1437 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_selectionListElement1440 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SELECTION_STREAM_in_selectionListElement1454 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_selectionListElement1456 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_selectionListElement1459 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_outerJoinIdent_in_outerJoin1478 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LEFT_OUTERJOIN_EXPR_in_outerJoinIdent1492 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1494 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1497 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1501 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1504 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_RIGHT_OUTERJOIN_EXPR_in_outerJoinIdent1519 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1521 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1524 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1528 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1531 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_FULL_OUTERJOIN_EXPR_in_outerJoinIdent1546 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1548 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1551 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1555 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1558 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_INNERJOIN_EXPR_in_outerJoinIdent1573 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1575 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1578 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1582 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1585 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_STREAM_EXPR_in_streamExpression1606 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventFilterExpr_in_streamExpression1609 = new BitSet(new long[]{0xC000000000000008L,0x0000000000000001L,0x0000000000000010L,0x2000000000000000L});
    public static final BitSet FOLLOW_patternInclusionExpression_in_streamExpression1613 = new BitSet(new long[]{0xC000000000000008L,0x0000000000000001L,0x0000000000000010L,0x2000000000000000L});
    public static final BitSet FOLLOW_databaseJoinExpression_in_streamExpression1617 = new BitSet(new long[]{0xC000000000000008L,0x0000000000000001L,0x0000000000000010L,0x2000000000000000L});
    public static final BitSet FOLLOW_methodJoinExpression_in_streamExpression1621 = new BitSet(new long[]{0xC000000000000008L,0x0000000000000001L,0x0000000000000010L,0x2000000000000000L});
    public static final BitSet FOLLOW_viewListExpr_in_streamExpression1625 = new BitSet(new long[]{0xC000000000000008L,0x0000000000000001L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_streamExpression1630 = new BitSet(new long[]{0xC000000000000008L,0x0000000000000001L});
    public static final BitSet FOLLOW_UNIDIRECTIONAL_in_streamExpression1635 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000001L});
    public static final BitSet FOLLOW_set_in_streamExpression1639 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_EXPR_in_eventFilterExpr1663 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventFilterExpr1665 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_eventFilterExpr1668 = new BitSet(new long[]{0x0000000037CC23C8L,0x0010000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_propertyExpression_in_eventFilterExpr1670 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_eventFilterExpr1674 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_EVENT_FILTER_PROPERTY_EXPR_in_propertyExpression1694 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_propertyExpressionAtom_in_propertyExpression1696 = new BitSet(new long[]{0x0000000000000008L,0x0020000000000000L});
    public static final BitSet FOLLOW_EVENT_FILTER_PROPERTY_EXPR_ATOM_in_propertyExpressionAtom1715 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_propertySelectionListElement_in_propertyExpressionAtom1717 = new BitSet(new long[]{0x0000000000000000L,0x01C0000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_propertyExpressionAtom1720 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000080L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_propertyExpressionAtom1723 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000080L});
    public static final BitSet FOLLOW_WHERE_EXPR_in_propertyExpressionAtom1727 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_propertyExpressionAtom1729 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PROPERTY_WILDCARD_SELECT_in_propertySelectionListElement1749 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PROPERTY_SELECTION_ELEMENT_EXPR_in_propertySelectionListElement1759 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_propertySelectionListElement1761 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_propertySelectionListElement1764 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PROPERTY_SELECTION_STREAM_in_propertySelectionListElement1778 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_propertySelectionListElement1780 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_propertySelectionListElement1783 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PATTERN_INCL_EXPR_in_patternInclusionExpression1804 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_patternInclusionExpression1806 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_DATABASE_JOIN_EXPR_in_databaseJoinExpression1823 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_databaseJoinExpression1825 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000600L});
    public static final BitSet FOLLOW_set_in_databaseJoinExpression1827 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000600L});
    public static final BitSet FOLLOW_set_in_databaseJoinExpression1835 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_METHOD_JOIN_EXPR_in_methodJoinExpression1856 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_methodJoinExpression1858 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_methodJoinExpression1860 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_methodJoinExpression1863 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_viewExpr_in_viewListExpr1877 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_viewExpr_in_viewListExpr1880 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_VIEW_EXPR_in_viewExpr1897 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_viewExpr1899 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_viewExpr1901 = new BitSet(new long[]{0x0020000037CC23C8L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExprWithTime_in_viewExpr1904 = new BitSet(new long[]{0x0020000037CC23C8L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    public static final BitSet FOLLOW_WHERE_EXPR_in_whereClause1926 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_whereClause1928 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GROUP_BY_EXPR_in_groupByClause1946 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_groupByClause1948 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_groupByClause1951 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_ORDER_BY_EXPR_in_orderByClause1969 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_orderByElement_in_orderByClause1971 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000010000000L});
    public static final BitSet FOLLOW_orderByElement_in_orderByClause1974 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000010000000L});
    public static final BitSet FOLLOW_ORDER_ELEMENT_EXPR_in_orderByElement1994 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_orderByElement1996 = new BitSet(new long[]{0x0600000000000008L});
    public static final BitSet FOLLOW_set_in_orderByElement1998 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_HAVING_EXPR_in_havingClause2021 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_havingClause2023 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_LIMIT_EXPR_in_outputLimitExpr2041 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_outputLimitExpr2043 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x2000078000000000L});
    public static final BitSet FOLLOW_number_in_outputLimitExpr2055 = new BitSet(new long[]{0x0000000000000008L,0x0000020000000000L});
    public static final BitSet FOLLOW_IDENT_in_outputLimitExpr2057 = new BitSet(new long[]{0x0000000000000008L,0x0000020000000000L});
    public static final BitSet FOLLOW_outputLimitAfter_in_outputLimitExpr2060 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_TIMEPERIOD_LIMIT_EXPR_in_outputLimitExpr2077 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_outputLimitExpr2079 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000800000000000L});
    public static final BitSet FOLLOW_timePeriod_in_outputLimitExpr2090 = new BitSet(new long[]{0x0000000000000008L,0x0000020000000000L});
    public static final BitSet FOLLOW_outputLimitAfter_in_outputLimitExpr2092 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CRONTAB_LIMIT_EXPR_in_outputLimitExpr2108 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_outputLimitExpr2110 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_crontabLimitParameterSet_in_outputLimitExpr2121 = new BitSet(new long[]{0x0000000000000008L,0x0000020000000000L});
    public static final BitSet FOLLOW_outputLimitAfter_in_outputLimitExpr2123 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_WHEN_LIMIT_EXPR_in_outputLimitExpr2139 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_outputLimitExpr2141 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_outputLimitExpr2152 = new BitSet(new long[]{0x0000000000000008L,0x0000020000000000L,0x0000000000000000L,0x0000000000238000L});
    public static final BitSet FOLLOW_onSetExpr_in_outputLimitExpr2154 = new BitSet(new long[]{0x0000000000000008L,0x0000020000000000L});
    public static final BitSet FOLLOW_outputLimitAfter_in_outputLimitExpr2157 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_AFTER_LIMIT_EXPR_in_outputLimitExpr2170 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_outputLimitAfter_in_outputLimitExpr2172 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_AFTER_in_outputLimitAfter2187 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_timePeriod_in_outputLimitAfter2189 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000078000000000L});
    public static final BitSet FOLLOW_number_in_outputLimitAfter2192 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ROW_LIMIT_EXPR_in_rowLimitClause2208 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_number_in_rowLimitClause2211 = new BitSet(new long[]{0x0000000000000008L,0x0000000400000000L,0x0000000000000000L,0x3000078000000000L});
    public static final BitSet FOLLOW_IDENT_in_rowLimitClause2213 = new BitSet(new long[]{0x0000000000000008L,0x0000000400000000L,0x0000000000000000L,0x3000078000000000L});
    public static final BitSet FOLLOW_number_in_rowLimitClause2217 = new BitSet(new long[]{0x0000000000000008L,0x0000000400000000L,0x0000000000000000L,0x1000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_rowLimitClause2219 = new BitSet(new long[]{0x0000000000000008L,0x0000000400000000L,0x0000000000000000L,0x1000000000000000L});
    public static final BitSet FOLLOW_COMMA_in_rowLimitClause2223 = new BitSet(new long[]{0x0000000000000008L,0x0000000400000000L});
    public static final BitSet FOLLOW_OFFSET_in_rowLimitClause2226 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CRONTAB_LIMIT_EXPR_PARAM_in_crontabLimitParameterSet2244 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2246 = new BitSet(new long[]{0x0020000037CC23C0L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2248 = new BitSet(new long[]{0x0020000037CC23C0L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    ...
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2254 = new BitSet(new long[]{0x0020000037CC23C8L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2256 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_LT_in_relationalExpr2273 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_relationalExprValue_in_relationalExpr2275 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GT_in_relationalExpr2288 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_relationalExprValue_in_relationalExpr2290 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_LE_in_relationalExpr2303 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_relationalExprValue_in_relationalExpr2305 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GE_in_relationalExpr2317 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_relationalExprValue_in_relationalExpr2319 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_valueExpr_in_relationalExprValue2341 = new BitSet(new long[]{0x0003800037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_relationalExprValue2351 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_relationalExprValue2366 = new BitSet(new long[]{0x0000000037CC23C2L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023FL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_relationalExprValue2375 = new BitSet(new long[]{0x0000000037CC23C2L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_subSelectGroupExpr_in_relationalExprValue2380 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EVAL_OR_EXPR_in_evalExprChoice2406 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2408 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2410 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2413 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_EVAL_AND_EXPR_in_evalExprChoice2427 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2429 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2431 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2434 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_EVAL_EQUALS_EXPR_in_evalExprChoice2448 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2450 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2452 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVAL_NOTEQUALS_EXPR_in_evalExprChoice2464 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2466 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2468 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVAL_EQUALS_GROUP_EXPR_in_evalExprChoice2480 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2482 = new BitSet(new long[]{0x0003800000000000L});
    public static final BitSet FOLLOW_set_in_evalExprChoice2484 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023FL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2493 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_subSelectGroupExpr_in_evalExprChoice2498 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVAL_NOTEQUALS_GROUP_EXPR_in_evalExprChoice2511 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2513 = new BitSet(new long[]{0x0003800000000000L});
    public static final BitSet FOLLOW_set_in_evalExprChoice2515 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023FL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2524 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_subSelectGroupExpr_in_evalExprChoice2529 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_EXPR_in_evalExprChoice2542 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2544 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_relationalExpr_in_evalExprChoice2555 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_constant_in_valueExpr2568 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_substitution_in_valueExpr2574 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_arithmeticExpr_in_valueExpr2580 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_valueExpr2587 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_evalExprChoice_in_valueExpr2596 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_builtinFunc_in_valueExpr2601 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_libFunc_in_valueExpr2609 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_caseExpr_in_valueExpr2614 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_inExpr_in_valueExpr2619 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_betweenExpr_in_valueExpr2625 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_likeExpr_in_valueExpr2630 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_regExpExpr_in_valueExpr2635 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_arrayExpr_in_valueExpr2640 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_subSelectInExpr_in_valueExpr2645 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_subSelectRowExpr_in_valueExpr2651 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_subSelectExistsExpr_in_valueExpr2658 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LAST_in_valueExprWithTime2671 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LW_in_valueExprWithTime2680 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_valueExpr_in_valueExprWithTime2687 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OBJECT_PARAM_ORDERED_EXPR_in_valueExprWithTime2695 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_valueExprWithTime2697 = new BitSet(new long[]{0x0600000000000000L});
    public static final BitSet FOLLOW_set_in_valueExprWithTime2699 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_rangeOperator_in_valueExprWithTime2712 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_frequencyOperator_in_valueExprWithTime2718 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_lastOperator_in_valueExprWithTime2723 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_weekDayOperator_in_valueExprWithTime2728 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NUMERIC_PARAM_LIST_in_valueExprWithTime2738 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_numericParameterList_in_valueExprWithTime2740 = new BitSet(new long[]{0x0000000000000008L,0x0000140000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_NUMBERSETSTAR_in_valueExprWithTime2751 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_timePeriod_in_valueExprWithTime2758 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_constant_in_numericParameterList2771 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_rangeOperator_in_numericParameterList2778 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_frequencyOperator_in_numericParameterList2784 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NUMERIC_PARAM_RANGE_in_rangeOperator2800 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_constant_in_rangeOperator2803 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L,0x00003F8000000200L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_rangeOperator2806 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L,0x00003F8000000200L});
    public static final BitSet FOLLOW_substitution_in_rangeOperator2809 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L,0x00003F8000000200L});
    public static final BitSet FOLLOW_constant_in_rangeOperator2813 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_rangeOperator2816 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_substitution_in_rangeOperator2819 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NUMERIC_PARAM_FREQUENCY_in_frequencyOperator2840 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_constant_in_frequencyOperator2843 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_frequencyOperator2846 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_substitution_in_frequencyOperator2849 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_LAST_OPERATOR_in_lastOperator2868 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_constant_in_lastOperator2871 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_lastOperator2874 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_substitution_in_lastOperator2877 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_WEEKDAY_OPERATOR_in_weekDayOperator2896 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_constant_in_weekDayOperator2899 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_weekDayOperator2902 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_substitution_in_weekDayOperator2905 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SUBSELECT_GROUP_EXPR_in_subSelectGroupExpr2926 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_subQueryExpr_in_subSelectGroupExpr2928 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SUBSELECT_EXPR_in_subSelectRowExpr2947 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_subQueryExpr_in_subSelectRowExpr2949 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EXISTS_SUBSELECT_EXPR_in_subSelectExistsExpr2968 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_subQueryExpr_in_subSelectExistsExpr2970 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_IN_SUBSELECT_EXPR_in_subSelectInExpr2989 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_subSelectInExpr2991 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_subSelectInQueryExpr_in_subSelectInExpr2993 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_IN_SUBSELECT_EXPR_in_subSelectInExpr3005 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_subSelectInExpr3007 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_subSelectInQueryExpr_in_subSelectInExpr3009 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_IN_SUBSELECT_QUERY_EXPR_in_subSelectInQueryExpr3028 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_subQueryExpr_in_subSelectInQueryExpr3030 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_DISTINCT_in_subQueryExpr3046 = new BitSet(new long[]{0x0000400000000000L,0x0000000000000000L,0x20000000000C0000L});
    public static final BitSet FOLLOW_selectionListElement_in_subQueryExpr3049 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000100000L});
    public static final BitSet FOLLOW_subSelectFilterExpr_in_subQueryExpr3051 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000080L});
    public static final BitSet FOLLOW_whereClause_in_subQueryExpr3054 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STREAM_EXPR_in_subSelectFilterExpr3072 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventFilterExpr_in_subSelectFilterExpr3074 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000001L,0x0000000000000010L,0x2000000000000000L});
    public static final BitSet FOLLOW_viewListExpr_in_subSelectFilterExpr3077 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000001L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_subSelectFilterExpr3082 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000001L});
    public static final BitSet FOLLOW_RETAINUNION_in_subSelectFilterExpr3086 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000001L});
    public static final BitSet FOLLOW_RETAININTERSECTION_in_subSelectFilterExpr3089 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CASE_in_caseExpr3109 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_caseExpr3112 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_CASE2_in_caseExpr3125 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_caseExpr3128 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_IN_SET_in_inExpr3148 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3150 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000041L});
    public static final BitSet FOLLOW_set_in_inExpr3152 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3158 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077989EL});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3161 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077989EL});
    public static final BitSet FOLLOW_set_in_inExpr3165 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_IN_SET_in_inExpr3180 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3182 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000041L});
    public static final BitSet FOLLOW_set_in_inExpr3184 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3190 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077989EL});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3193 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077989EL});
    public static final BitSet FOLLOW_set_in_inExpr3197 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_IN_RANGE_in_inExpr3212 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3214 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000041L});
    public static final BitSet FOLLOW_set_in_inExpr3216 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3222 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3224 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_set_in_inExpr3226 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_IN_RANGE_in_inExpr3241 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3243 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000041L});
    public static final BitSet FOLLOW_set_in_inExpr3245 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3251 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3253 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_set_in_inExpr3255 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_BETWEEN_in_betweenExpr3278 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3280 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3282 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3284 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_BETWEEN_in_betweenExpr3295 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3297 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3299 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3302 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_LIKE_in_likeExpr3322 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3324 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3326 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3329 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_LIKE_in_likeExpr3342 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3344 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3346 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3349 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_REGEXP_in_regExpExpr3368 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_regExpExpr3370 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_regExpExpr3372 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_REGEXP_in_regExpExpr3383 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_regExpExpr3385 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_regExpExpr3387 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SUM_in_builtinFunc3406 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3409 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3413 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_AVG_in_builtinFunc3424 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3427 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3431 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_COUNT_in_builtinFunc3442 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3446 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3450 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MEDIAN_in_builtinFunc3464 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3467 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3471 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_STDDEV_in_builtinFunc3482 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3485 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3489 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_AVEDEV_in_builtinFunc3500 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3503 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3507 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_LAST_AGGREG_in_builtinFunc3518 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3521 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3525 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_FIRST_AGGREG_in_builtinFunc3536 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3539 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3543 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_COALESCE_in_builtinFunc3555 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3557 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3559 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3562 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_PREVIOUS_in_builtinFunc3577 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3579 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3581 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PRIOR_in_builtinFunc3594 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_NUM_INT_in_builtinFunc3598 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_builtinFunc3600 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_INSTANCEOF_in_builtinFunc3613 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3615 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_builtinFunc3617 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_builtinFunc3620 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_CAST_in_builtinFunc3634 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3636 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_builtinFunc3638 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EXISTS_in_builtinFunc3650 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_builtinFunc3652 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CURRENT_TIMESTAMP_in_builtinFunc3664 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ARRAY_EXPR_in_arrayExpr3684 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arrayExpr3687 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_PLUS_in_arithmeticExpr3708 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3710 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3712 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MINUS_in_arithmeticExpr3724 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3726 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3728 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_DIV_in_arithmeticExpr3740 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3742 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3744 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_STAR_in_arithmeticExpr3755 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3757 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3759 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MOD_in_arithmeticExpr3771 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3773 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3775 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_BAND_in_arithmeticExpr3786 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3788 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3790 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_BOR_in_arithmeticExpr3801 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3803 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3805 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_BXOR_in_arithmeticExpr3816 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3818 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3820 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CONCAT_in_arithmeticExpr3832 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3834 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3836 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3839 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_LIB_FUNCTION_in_libFunc3860 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_libFunc3863 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_libFunc3867 = new BitSet(new long[]{0x0000400037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_DISTINCT_in_libFunc3870 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_libFunc3875 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_annotation_in_startPatternExpressionRule3895 = new BitSet(new long[]{0x000000000000D800L,0x0003400000000000L,0x000000000000000CL,0x0000000101000000L});
    public static final BitSet FOLLOW_exprChoice_in_startPatternExpressionRule3899 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_atomicExpr_in_exprChoice3913 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_patternOp_in_exprChoice3918 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EVERY_EXPR_in_exprChoice3928 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_exprChoice3930 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVERY_DISTINCT_EXPR_in_exprChoice3944 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_distinctExpressions_in_exprChoice3946 = new BitSet(new long[]{0x000000000000D800L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_exprChoice3948 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PATTERN_NOT_EXPR_in_exprChoice3962 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_exprChoice3964 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GUARD_EXPR_in_exprChoice3978 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_exprChoice3980 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_exprChoice3982 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_exprChoice3984 = new BitSet(new long[]{0x0020000037CC23C8L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExprWithTime_in_exprChoice3986 = new BitSet(new long[]{0x0020000037CC23C8L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    public static final BitSet FOLLOW_MATCH_UNTIL_EXPR_in_exprChoice4000 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRange_in_exprChoice4002 = new BitSet(new long[]{0x000000000000D800L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_exprChoice4005 = new BitSet(new long[]{0x000000000000D808L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_exprChoice4007 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PATTERN_EVERY_DISTINCT_EXPR_in_distinctExpressions4028 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_distinctExpressions4030 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_FOLLOWED_BY_EXPR_in_patternOp4049 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4051 = new BitSet(new long[]{0x000000000000D800L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4053 = new BitSet(new long[]{0x000000000000D808L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4056 = new BitSet(new long[]{0x000000000000D808L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_OR_EXPR_in_patternOp4072 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4074 = new BitSet(new long[]{0x000000000000D800L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4076 = new BitSet(new long[]{0x000000000000D808L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4079 = new BitSet(new long[]{0x000000000000D808L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_AND_EXPR_in_patternOp4095 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4097 = new BitSet(new long[]{0x000000000000D800L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4099 = new BitSet(new long[]{0x000000000000D808L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4102 = new BitSet(new long[]{0x000000000000D808L,0x0003400000000000L,0x000000000000000CL,0x0000000001000000L});
    public static final BitSet FOLLOW_patternFilterExpr_in_atomicExpr4121 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OBSERVER_EXPR_in_atomicExpr4133 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_atomicExpr4135 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_IDENT_in_atomicExpr4137 = new BitSet(new long[]{0x0020000037CC23C8L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExprWithTime_in_atomicExpr4139 = new BitSet(new long[]{0x0020000037CC23C8L,0x00003C0000000F70L,0x83C1B0002000FC00L,0x00003F98800003BBL,0x000000000077981CL});
    public static final BitSet FOLLOW_PATTERN_FILTER_EXPR_in_patternFilterExpr4159 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_patternFilterExpr4161 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_patternFilterExpr4164 = new BitSet(new long[]{0x0000000037CC23C8L,0x0010000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_propertyExpression_in_patternFilterExpr4166 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_patternFilterExpr4170 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_MATCH_UNTIL_RANGE_CLOSED_in_matchUntilRange4188 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4190 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000400000000000L,0x0000000002000000L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4192 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCH_UNTIL_RANGE_BOUNDED_in_matchUntilRange4200 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4202 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCH_UNTIL_RANGE_HALFCLOSED_in_matchUntilRange4210 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4212 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCH_UNTIL_RANGE_HALFOPEN_in_matchUntilRange4219 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4221 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_matchUntilRangeParam0 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EVENT_FILTER_PARAM_in_filterParam4250 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_filterParam4252 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_valueExpr_in_filterParam4255 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000000E70L,0x83C130002000FC00L,0x00003F980000023BL,0x000000000077981CL});
    public static final BitSet FOLLOW_EQUALS_in_filterParamComparator4271 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4273 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_EQUAL_in_filterParamComparator4280 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4282 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_LT_in_filterParamComparator4289 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4291 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_LE_in_filterParamComparator4298 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4300 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GT_in_filterParamComparator4307 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4309 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GE_in_filterParamComparator4316 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4318 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_RANGE_in_filterParamComparator4325 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4327 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4334 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4337 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4341 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4344 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4347 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_NOT_RANGE_in_filterParamComparator4358 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4360 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4367 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4370 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4374 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4377 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4380 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_IN_in_filterParamComparator4391 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4393 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4400 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4403 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4407 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4410 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4414 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_NOT_IN_in_filterParamComparator4425 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4427 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4434 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4437 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4441 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4444 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L,0x0000000000000082L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4448 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_BETWEEN_in_filterParamComparator4459 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4462 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4465 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4469 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4472 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_NOT_BETWEEN_in_filterParamComparator4480 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4483 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4486 = new BitSet(new long[]{0x0000000000000000L,0x0200000000000000L,0x0000000000000000L,0x00003F8000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4490 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4493 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_constant_in_filterAtom4507 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterAtom4513 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EVENT_FILTER_IDENT_in_filterIdentifier4524 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_filterIdentifier4526 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_filterIdentifier4528 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_EXPR_in_eventPropertyExpr4547 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyAtomic_in_eventPropertyExpr4549 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000FC0000000L});
    public static final BitSet FOLLOW_eventPropertyAtomic_in_eventPropertyExpr4552 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000FC0000000L});
    public static final BitSet FOLLOW_EVENT_PROP_SIMPLE_in_eventPropertyAtomic4571 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4573 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_INDEXED_in_eventPropertyAtomic4580 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4582 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000002000000L});
    public static final BitSet FOLLOW_NUM_INT_in_eventPropertyAtomic4584 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_MAPPED_in_eventPropertyAtomic4591 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4593 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000600L});
    public static final BitSet FOLLOW_set_in_eventPropertyAtomic4595 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_DYNAMIC_SIMPLE_in_eventPropertyAtomic4608 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4610 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_DYNAMIC_INDEXED_in_eventPropertyAtomic4617 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4619 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000002000000L});
    public static final BitSet FOLLOW_NUM_INT_in_eventPropertyAtomic4621 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_DYNAMIC_MAPPED_in_eventPropertyAtomic4628 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4630 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000600L});
    public static final BitSet FOLLOW_set_in_eventPropertyAtomic4632 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_TIME_PERIOD_in_timePeriod4657 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_timePeriodDef_in_timePeriod4659 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_dayPart_in_timePeriodDef4675 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x003C000000000000L});
    public static final BitSet FOLLOW_hourPart_in_timePeriodDef4678 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0038000000000000L});
    public static final BitSet FOLLOW_minutePart_in_timePeriodDef4683 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0030000000000000L});
    public static final BitSet FOLLOW_secondPart_in_timePeriodDef4688 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0020000000000000L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4693 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_hourPart_in_timePeriodDef4700 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0038000000000000L});
    public static final BitSet FOLLOW_minutePart_in_timePeriodDef4703 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0030000000000000L});
    public static final BitSet FOLLOW_secondPart_in_timePeriodDef4708 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0020000000000000L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4713 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_minutePart_in_timePeriodDef4720 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0030000000000000L});
    public static final BitSet FOLLOW_secondPart_in_timePeriodDef4723 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0020000000000000L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4728 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_secondPart_in_timePeriodDef4735 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0020000000000000L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4738 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4745 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DAY_PART_in_dayPart4759 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_dayPart4761 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_HOUR_PART_in_hourPart4776 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_hourPart4778 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MINUTE_PART_in_minutePart4793 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_minutePart4795 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SECOND_PART_in_secondPart4810 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_secondPart4812 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MILLISECOND_PART_in_millisecondPart4827 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_millisecondPart4829 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SUBSTITUTION_in_substitution4844 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INT_TYPE_in_constant4860 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LONG_TYPE_in_constant4869 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FLOAT_TYPE_in_constant4878 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DOUBLE_TYPE_in_constant4887 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_TYPE_in_constant4903 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_BOOL_TYPE_in_constant4919 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NULL_TYPE_in_constant4932 = new BitSet(new long[]{0x0000000000000002L});
