// $ANTLR 3.1.1 EsperEPL2Ast.g 2010-06-08 17:50:05
...
public class EsperEPL2Ast extends TreeParser {
    ...
    // EsperEPL2Ast.g:567:1: exprChoice : ( atomicExpr | patternOp | ^(a= EVERY_EXPR exprChoice ) | ^(a= EVERY_DISTINCT_EXPR distinctExpressions exprChoice ) | ^(n= PATTERN_NOT_EXPR exprChoice ) | ^(g= GUARD_EXPR exprChoice IDENT IDENT ( valueExprWithTime )* ) | ^(m= MATCH_UNTIL_EXPR ( matchUntilRange )? exprChoice ( exprChoice )? ) );
    public final void exprChoice() throws RecognitionException {
        ...
        try {
            // EsperEPL2Ast.g:568:2: ( atomicExpr | patternOp | ^(a= EVERY_EXPR exprChoice ) | ^(a= EVERY_DISTINCT_EXPR distinctExpressions exprChoice ) | ^(n= PATTERN_NOT_EXPR exprChoice ) | ^(g= GUARD_EXPR exprChoice IDENT IDENT ( valueExprWithTime )* ) | ^(m= MATCH_UNTIL_EXPR ( matchUntilRange )? exprChoice ( exprChoice )? ) )
            int alt194=7;
            switch ( input.LA(1) ) {
            ...
            switch (alt194) {
                ...
                case 5 :
                    ...
                    break;
                case 6 :
                    // EsperEPL2Ast.g:573:5: ^(g= GUARD_EXPR exprChoice IDENT IDENT ( valueExprWithTime )* )
                    {
                    ...
                    match(input,IDENT,FOLLOW_IDENT_in_exprChoice4125); 
                    match(input,IDENT,FOLLOW_IDENT_in_exprChoice4127); 
                    // EsperEPL2Ast.g:573:44: ( valueExprWithTime )*
                    loop191:
                    do {
                        int alt191=2;
                    	...
                    	case 1 :
                    	    // EsperEPL2Ast.g:573:44: valueExprWithTime
                    	    {
                    	    pushFollow(FOLLOW_valueExprWithTime_in_exprChoice4129);
                    	    valueExprWithTime();
                ...
                case 7 :
                    ...
                    {
                    m=(CommonTree)match(input,MATCH_UNTIL_EXPR,FOLLOW_MATCH_UNTIL_EXPR_in_exprChoice4143); 
                    ...
                    if ( ((LA192_0>=MATCH_UNTIL_RANGE_HALFOPEN && LA192_0<=MATCH_UNTIL_RANGE_BOUNDED)) ) {
                        alt192=1;
                    }
                    switch (alt192) {
                        case 1 :
                            // EsperEPL2Ast.g:574:26: matchUntilRange
                            {
                            pushFollow(FOLLOW_matchUntilRange_in_exprChoice4145);
                            matchUntilRange();
                    ...
                    pushFollow(FOLLOW_exprChoice_in_exprChoice4148);
                    exprChoice();
                    ...
                    if ( ((LA193_0>=OR_EXPR && LA193_0<=AND_EXPR)||(LA193_0>=EVERY_EXPR && LA193_0<=EVERY_DISTINCT_EXPR)||LA193_0==FOLLOWED_BY_EXPR||(LA193_0>=PATTERN_FILTER_EXPR && LA193_0<=PATTERN_NOT_EXPR)||(LA193_0>=GUARD_EXPR && LA193_0<=OBSERVER_EXPR)||LA193_0==MATCH_UNTIL_EXPR) ) {
                        alt193=1;
                    }
                    switch (alt193) {
                        case 1 :
                            // EsperEPL2Ast.g:574:54: exprChoice
                            {
                            pushFollow(FOLLOW_exprChoice_in_exprChoice4150);
                            exprChoice();
    ...
    public final void distinctExpressions() throws RecognitionException {
        try {
            ...
            {
            match(input,PATTERN_EVERY_DISTINCT_EXPR,FOLLOW_PATTERN_EVERY_DISTINCT_EXPR_in_distinctExpressions4171); 
            ...
            do {
            	...
            	case 1 :
            	    // EsperEPL2Ast.g:579:35: valueExpr
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_distinctExpressions4173);
            	    valueExpr();
        ...
        try {
            ...
            switch (alt199) {
                case 1 :
                    ...
                    {
                    f=(CommonTree)match(input,FOLLOWED_BY_EXPR,FOLLOW_FOLLOWED_BY_EXPR_in_patternOp4192); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_exprChoice_in_patternOp4194);
                    exprChoice();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_exprChoice_in_patternOp4199);
                    	    exprChoice();
                ...
                case 2 :
                    ...
                    {
                    o=(CommonTree)match(input,OR_EXPR,FOLLOW_OR_EXPR_in_patternOp4215); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_exprChoice_in_patternOp4217);
                    exprChoice();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_exprChoice_in_patternOp4222);
                    	    exprChoice();
                ...
                case 3 :
                    ...
                    {
                    a=(CommonTree)match(input,AND_EXPR,FOLLOW_AND_EXPR_in_patternOp4238); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_exprChoice_in_patternOp4240);
                    exprChoice();

                    state._fsp--;

                    pushFollow(FOLLOW_exprChoice_in_patternOp4242);
                    exprChoice();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_exprChoice_in_patternOp4245);
                    	    exprChoice();
    ...
    public final void atomicExpr() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA201_0==PATTERN_FILTER_EXPR) ) {
                alt201=1;
            }
            else if ( (LA201_0==OBSERVER_EXPR) ) {
                alt201=2;
            }
            else {
                NoViableAltException nvae =
            ...
            switch (alt201) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_patternFilterExpr_in_atomicExpr4264);
                    patternFilterExpr();
                ...
                case 2 :
                    ...
                    {
                    ac=(CommonTree)match(input,OBSERVER_EXPR,FOLLOW_OBSERVER_EXPR_in_atomicExpr4276); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_atomicExpr4278); 
                    match(input,IDENT,FOLLOW_IDENT_in_atomicExpr4280); 
                    ...
                    do {
                        ...
                        if ( ((LA200_0>=IN_SET && LA200_0<=REGEXP)||LA200_0==NOT_EXPR||(LA200_0>=SUM && LA200_0<=AVG)||(LA200_0>=COALESCE && LA200_0<=COUNT)||(LA200_0>=CASE && LA200_0<=CASE2)||LA200_0==LAST||(LA200_0>=PREVIOUS && LA200_0<=EXISTS)||(LA200_0>=LW && LA200_0<=CURRENT_TIMESTAMP)||(LA200_0>=NUMERIC_PARAM_RANGE && LA200_0<=OBJECT_PARAM_ORDERED_EXPR)||(LA200_0>=EVAL_AND_EXPR && LA200_0<=EVAL_NOTEQUALS_GROUP_EXPR)||LA200_0==EVENT_PROP_EXPR||(LA200_0>=CONCAT && LA200_0<=LIB_FUNCTION)||(LA200_0>=TIME_PERIOD && LA200_0<=ARRAY_EXPR)||(LA200_0>=NOT_IN_SET && LA200_0<=NOT_REGEXP)||(LA200_0>=IN_RANGE && LA200_0<=SUBSELECT_EXPR)||(LA200_0>=EXISTS_SUBSELECT_EXPR && LA200_0<=NOT_IN_SUBSELECT_EXPR)||(LA200_0>=LAST_OPERATOR && LA200_0<=SUBSTITUTION)||LA200_0==NUMBERSETSTAR||(LA200_0>=FIRST_AGGREG && LA200_0<=LAST_AGGREG)||(LA200_0>=INT_TYPE && LA200_0<=NULL_TYPE)||(LA200_0>=STAR && LA200_0<=PLUS)||(LA200_0>=BAND && LA200_0<=BXOR)||(LA200_0>=LT && LA200_0<=GE)||(LA200_0>=MINUS && LA200_0<=MOD)) ) {
                            alt200=1;
                        }
                    	...
                    	case 1 :
                    	    // EsperEPL2Ast.g:590:39: valueExprWithTime
                    	    {
                    	    pushFollow(FOLLOW_valueExprWithTime_in_atomicExpr4282);
                    	    valueExprWithTime();
    ...
    public final void patternFilterExpr() throws RecognitionException {
        ...
        try {
            ...
            {
            f=(CommonTree)match(input,PATTERN_FILTER_EXPR,FOLLOW_PATTERN_FILTER_EXPR_in_patternFilterExpr4302); 
            ...
            switch (alt202) {
                case 1 :
                    // EsperEPL2Ast.g:594:29: IDENT
                    {
                    match(input,IDENT,FOLLOW_IDENT_in_patternFilterExpr4304); 
            ...
            match(input,CLASS_IDENT,FOLLOW_CLASS_IDENT_in_patternFilterExpr4307); 
            // EsperEPL2Ast.g:594:48: ( propertyExpression )?
            int alt203=2;
            int LA203_0 = input.LA(1);

            if ( (LA203_0==EVENT_FILTER_PROPERTY_EXPR) ) {
                alt203=1;
            }
            switch (alt203) {
                case 1 :
                    // EsperEPL2Ast.g:594:48: propertyExpression
                    {
                    pushFollow(FOLLOW_propertyExpression_in_patternFilterExpr4309);
                    propertyExpression();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_patternFilterExpr4313);
            	    valueExpr();
        ...
        try {
            ...
            switch (alt205) {
                case 1 :
                    ...
                    {
                    match(input,MATCH_UNTIL_RANGE_CLOSED,FOLLOW_MATCH_UNTIL_RANGE_CLOSED_in_matchUntilRange4331); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4333);
                    matchUntilRangeParam();

                    state._fsp--;

                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4335);
                    matchUntilRangeParam();
                ...
                case 2 :
                    ...
                    {
                    match(input,MATCH_UNTIL_RANGE_BOUNDED,FOLLOW_MATCH_UNTIL_RANGE_BOUNDED_in_matchUntilRange4343); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4345);
                    matchUntilRangeParam();
                ...
                case 3 :
                    ...
                    {
                    match(input,MATCH_UNTIL_RANGE_HALFCLOSED,FOLLOW_MATCH_UNTIL_RANGE_HALFCLOSED_in_matchUntilRange4353); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4355);
                    matchUntilRangeParam();
                ...
                case 4 :
                    ...
                    {
                    match(input,MATCH_UNTIL_RANGE_HALFOPEN,FOLLOW_MATCH_UNTIL_RANGE_HALFOPEN_in_matchUntilRange4362); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_matchUntilRangeParam_in_matchUntilRange4364);
                    matchUntilRangeParam();
    ...
    public final void filterParam() throws RecognitionException {
        try {
            ...
            {
            match(input,EVENT_FILTER_PARAM,FOLLOW_EVENT_FILTER_PARAM_in_filterParam4393); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_filterParam4395);
            valueExpr();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_valueExpr_in_filterParam4398);
            	    valueExpr();
        ...
        try {
            ...
            switch (alt219) {
                case 1 :
                    ...
                    {
                    match(input,EQUALS,FOLLOW_EQUALS_in_filterParamComparator4414); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4416);
                    filterAtom();
                ...
                case 2 :
                    ...
                    {
                    match(input,NOT_EQUAL,FOLLOW_NOT_EQUAL_in_filterParamComparator4423); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4425);
                    filterAtom();
                ...
                case 3 :
                    ...
                    {
                    match(input,LT,FOLLOW_LT_in_filterParamComparator4432); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4434);
                    filterAtom();
                ...
                case 4 :
                    ...
                    {
                    match(input,LE,FOLLOW_LE_in_filterParamComparator4441); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4443);
                    filterAtom();
                ...
                case 5 :
                    ...
                    {
                    match(input,GT,FOLLOW_GT_in_filterParamComparator4450); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_filterAtom_in_filterParamComparator4452);
                    filterAtom();
                ...
                case 6 :
                    ...
                    {
                    match(input,GE,FOLLOW_GE_in_filterParamComparator4459); 
                ...
                case 7 :
                    ...
                    {
                    match(input,EVENT_FILTER_RANGE,FOLLOW_EVENT_FILTER_RANGE_in_filterParamComparator4468); 
                    ...
                    switch (alt207) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4477);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4480);
                            filterIdentifier();
                ...
                case 8 :
                    ...
                    {
                    match(input,EVENT_FILTER_NOT_RANGE,FOLLOW_EVENT_FILTER_NOT_RANGE_in_filterParamComparator4501); 
                    ...
                    switch (alt209) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4510);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4513);
                            filterIdentifier();
                ...
                case 9 :
                    ...
                    {
                    match(input,EVENT_FILTER_IN,FOLLOW_EVENT_FILTER_IN_in_filterParamComparator4534); 
                    ...
                    switch (alt211) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4543);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4546);
                            filterIdentifier();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_constant_in_filterParamComparator4550);
                    	    constant(false);
                    	...
                    	case 2 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4553);
                    	    filterIdentifier();
                ...
                case 10 :
                    ...
                    {
                    match(input,EVENT_FILTER_NOT_IN,FOLLOW_EVENT_FILTER_NOT_IN_in_filterParamComparator4568); 
                    ...
                    switch (alt213) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4577);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4580);
                            filterIdentifier();
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_constant_in_filterParamComparator4584);
                    	    constant(false);
                    	...
                    	case 2 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4587);
                    	    filterIdentifier();
                ...
                case 11 :
                    ...
                    {
                    match(input,EVENT_FILTER_BETWEEN,FOLLOW_EVENT_FILTER_BETWEEN_in_filterParamComparator4602); 
                    ...
                    switch (alt215) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4605);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4608);
                            filterIdentifier();
                    ...
                    switch (alt216) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4612);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4615);
                            filterIdentifier();
                ...
                case 12 :
                    ...
                    {
                    match(input,EVENT_FILTER_NOT_BETWEEN,FOLLOW_EVENT_FILTER_NOT_BETWEEN_in_filterParamComparator4623); 
                    ...
                    switch (alt217) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_constant_in_filterParamComparator4626);
                            constant(false);
                        ...
                        case 2 :
                            ...
                            {
                            pushFollow(FOLLOW_filterIdentifier_in_filterParamComparator4629);
                            filterIdentifier();
        ...
        try {
            ...
            switch (alt220) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_constant_in_filterAtom4650);
                    constant(false);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_filterIdentifier_in_filterAtom4656);
                    filterIdentifier();
    ...
    public final void filterIdentifier() throws RecognitionException {
        try {
            ...
            {
            match(input,EVENT_FILTER_IDENT,FOLLOW_EVENT_FILTER_IDENT_in_filterIdentifier4667); 

            match(input, Token.DOWN, null); 
            match(input,IDENT,FOLLOW_IDENT_in_filterIdentifier4669); 
            pushFollow(FOLLOW_eventPropertyExpr_in_filterIdentifier4671);
            eventPropertyExpr(true);
    ...
    public final void eventPropertyExpr(boolean isLeaveNode) throws RecognitionException {
        ...
        try {
            ...
            {
            p=(CommonTree)match(input,EVENT_PROP_EXPR,FOLLOW_EVENT_PROP_EXPR_in_eventPropertyExpr4690); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_eventPropertyAtomic_in_eventPropertyExpr4692);
            eventPropertyAtomic();
            ...
            do {
                ...
                if ( ((LA221_0>=EVENT_PROP_SIMPLE && LA221_0<=EVENT_PROP_DYNAMIC_MAPPED)) ) {
                    alt221=1;
                }
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_eventPropertyAtomic_in_eventPropertyExpr4695);
            	    eventPropertyAtomic();
        ...
        try {
            ...
            switch (alt222) {
                case 1 :
                    ...
                    {
                    match(input,EVENT_PROP_SIMPLE,FOLLOW_EVENT_PROP_SIMPLE_in_eventPropertyAtomic4714); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4716); 
                ...
                case 2 :
                    ...
                    {
                    match(input,EVENT_PROP_INDEXED,FOLLOW_EVENT_PROP_INDEXED_in_eventPropertyAtomic4723); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4725); 
                    match(input,NUM_INT,FOLLOW_NUM_INT_in_eventPropertyAtomic4727); 
                ...
                case 3 :
                    ...
                    {
                    match(input,EVENT_PROP_MAPPED,FOLLOW_EVENT_PROP_MAPPED_in_eventPropertyAtomic4734); 
                ...
                case 4 :
                    ...
                    {
                    match(input,EVENT_PROP_DYNAMIC_SIMPLE,FOLLOW_EVENT_PROP_DYNAMIC_SIMPLE_in_eventPropertyAtomic4751); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4753); 
                ...
                case 5 :
                    ...
                    {
                    match(input,EVENT_PROP_DYNAMIC_INDEXED,FOLLOW_EVENT_PROP_DYNAMIC_INDEXED_in_eventPropertyAtomic4760); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4762); 
                    match(input,NUM_INT,FOLLOW_NUM_INT_in_eventPropertyAtomic4764); 
                ...
                case 6 :
                    ...
                    {
                    match(input,EVENT_PROP_DYNAMIC_MAPPED,FOLLOW_EVENT_PROP_DYNAMIC_MAPPED_in_eventPropertyAtomic4771); 

                    match(input, Token.DOWN, null); 
                    match(input,IDENT,FOLLOW_IDENT_in_eventPropertyAtomic4773); 
                    if ( (input.LA(1)>=STRING_LITERAL && input.LA(1)<=QUOTED_STRING_LITERAL) ) {
                        input.consume();
                        state.errorRecovery=false;
                    }
    ...
    public final void timePeriod() throws RecognitionException {
        ...
        try {
            ...
            {
            t=(CommonTree)match(input,TIME_PERIOD,FOLLOW_TIME_PERIOD_in_timePeriod4800); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_timePeriodDef_in_timePeriod4802);
            timePeriodDef();
        ...
        try {
            ...
            switch (alt233) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_dayPart_in_timePeriodDef4818);
                    dayPart();
                    ...
                    switch (alt223) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_hourPart_in_timePeriodDef4821);
                            hourPart();
                    ...
                    switch (alt224) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_minutePart_in_timePeriodDef4826);
                            minutePart();
                    ...
                    switch (alt225) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_secondPart_in_timePeriodDef4831);
                            secondPart();
                    ...
                    switch (alt226) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_millisecondPart_in_timePeriodDef4836);
                            millisecondPart();
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_hourPart_in_timePeriodDef4843);
                    hourPart();
                    ...
                    switch (alt227) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_minutePart_in_timePeriodDef4846);
                            minutePart();
                    ...
                    switch (alt228) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_secondPart_in_timePeriodDef4851);
                            secondPart();
                    ...
                    switch (alt229) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_millisecondPart_in_timePeriodDef4856);
                            millisecondPart();
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_minutePart_in_timePeriodDef4863);
                    minutePart();
                    ...
                    switch (alt230) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_secondPart_in_timePeriodDef4866);
                            secondPart();
                    ...
                    switch (alt231) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_millisecondPart_in_timePeriodDef4871);
                            millisecondPart();
                ...
                case 4 :
                    ...
                    {
                    pushFollow(FOLLOW_secondPart_in_timePeriodDef4878);
                    secondPart();
                ...
                case 5 :
                    ...
                    {
                    pushFollow(FOLLOW_millisecondPart_in_timePeriodDef4888);
                    millisecondPart();
    ...
    public final void dayPart() throws RecognitionException {
        try {
            ...
            {
            match(input,DAY_PART,FOLLOW_DAY_PART_in_dayPart4902); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_dayPart4904);
            valueExpr();
    ...
    public final void hourPart() throws RecognitionException {
        try {
            ...
            {
            match(input,HOUR_PART,FOLLOW_HOUR_PART_in_hourPart4919); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_hourPart4921);
            valueExpr();
    ...
    public final void minutePart() throws RecognitionException {
        try {
            ...
            {
            match(input,MINUTE_PART,FOLLOW_MINUTE_PART_in_minutePart4936); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_minutePart4938);
            valueExpr();
    ...
    public final void secondPart() throws RecognitionException {
        try {
            ...
            {
            match(input,SECOND_PART,FOLLOW_SECOND_PART_in_secondPart4953); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_secondPart4955);
            valueExpr();
    ...
    public final void millisecondPart() throws RecognitionException {
        try {
            ...
            {
            match(input,MILLISECOND_PART,FOLLOW_MILLISECOND_PART_in_millisecondPart4970); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_valueExpr_in_millisecondPart4972);
            valueExpr();
    ...
    public final void substitution() throws RecognitionException {
        ...
        try {
            ...
            {
            s=(CommonTree)match(input,SUBSTITUTION,FOLLOW_SUBSTITUTION_in_substitution4987); 
             leaveNode(s); 
        ...
        try {
            ...
            switch (alt234) {
                case 1 :
                    ...
                    {
                    c=(CommonTree)match(input,INT_TYPE,FOLLOW_INT_TYPE_in_constant5003); 
                ...
                case 2 :
                    ...
                    {
                    c=(CommonTree)match(input,LONG_TYPE,FOLLOW_LONG_TYPE_in_constant5012); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 3 :
                    ...
                    {
                    c=(CommonTree)match(input,FLOAT_TYPE,FOLLOW_FLOAT_TYPE_in_constant5021); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 4 :
                    ...
                    {
                    c=(CommonTree)match(input,DOUBLE_TYPE,FOLLOW_DOUBLE_TYPE_in_constant5030); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 5 :
                    ...
                    {
                    c=(CommonTree)match(input,STRING_TYPE,FOLLOW_STRING_TYPE_in_constant5046); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 6 :
                    ...
                    {
                    c=(CommonTree)match(input,BOOL_TYPE,FOLLOW_BOOL_TYPE_in_constant5062); 
                     if (isLeaveNode) leaveNode(c); 
                ...
                case 7 :
                    ...
                    {
                    c=(CommonTree)match(input,NULL_TYPE,FOLLOW_NULL_TYPE_in_constant5075); 
                     if (isLeaveNode) leaveNode(c); 
    ...
    public static final BitSet FOLLOW_CLASS_IDENT_in_annotation94 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000010L,0x003F807000000000L});
    public static final BitSet FOLLOW_elementValuePair_in_annotation96 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000010L,0x003F807000000000L});
    ...
    public static final BitSet FOLLOW_IDENT_in_elementValuePair119 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000010L,0x003F803000000000L});
    ...
    public static final BitSet FOLLOW_elementValue_in_elementValue158 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000010L,0x003F803000000000L});
    ...
    public static final BitSet FOLLOW_annotation_in_startEPLExpressionRule204 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000200000100000L,0x00000A100402C000L});
    ...
    public static final BitSet FOLLOW_onStreamExpr_in_onExpr273 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000002380000L});
    ...
    public static final BitSet FOLLOW_onSelectExpr_in_onExpr286 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_onSelectInsertExpr_in_onExpr289 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000C00000L});
    ...
    public static final BitSet FOLLOW_eventFilterExpr_in_onStreamExpr324 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_patternInclusionExpression_in_onStreamExpr328 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_CLASS_IDENT_in_updateExpr352 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000040000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_updateExpr354 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000040000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_onSetAssignment_in_updateExpr357 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000400L,0x0000040000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_onExprFrom_in_onDeleteExpr379 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_insertIntoExpr_in_onSelectExpr404 = new BitSet(new long[]{0x0000400000000000L,0x0000000000000000L,0x0000000000600000L,0x0000000000000001L});
    public static final BitSet FOLLOW_DISTINCT_in_onSelectExpr407 = new BitSet(new long[]{0x0000400000000000L,0x0000000000000000L,0x0000000000600000L,0x0000000000000001L});
    public static final BitSet FOLLOW_selectionList_in_onSelectExpr410 = new BitSet(new long[]{0x0000000000000008L,0x0000000800000000L,0x0000000060000C00L,0x0000000001000000L});
    public static final BitSet FOLLOW_onExprFrom_in_onSelectExpr412 = new BitSet(new long[]{0x0000000000000008L,0x0000000800000000L,0x0000000060000C00L});
    public static final BitSet FOLLOW_whereClause_in_onSelectExpr415 = new BitSet(new long[]{0x0000000000000008L,0x0000000800000000L,0x0000000060000800L});
    public static final BitSet FOLLOW_groupByClause_in_onSelectExpr419 = new BitSet(new long[]{0x0000000000000008L,0x0000000800000000L,0x0000000040000800L});
    public static final BitSet FOLLOW_havingClause_in_onSelectExpr422 = new BitSet(new long[]{0x0000000000000008L,0x0000000800000000L,0x0000000040000000L});
    ...
    public static final BitSet FOLLOW_insertIntoExpr_in_onSelectInsertExpr450 = new BitSet(new long[]{0x0000400000000000L,0x0000000000000000L,0x0000000000600000L,0x0000000000000001L});
    public static final BitSet FOLLOW_selectionList_in_onSelectInsertExpr452 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_onSetAssignment_in_onSetExpr493 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000400L,0x0000040000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_onSetAssignment_in_onSetExpr496 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000400L,0x0000040000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_onExprFrom_in_onUpdateExpr517 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000040000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_onSetAssignment_in_onUpdateExpr519 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000400L,0x0000040000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_eventPropertyExpr_in_onSetAssignment539 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_IDENT_in_onExprFrom558 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_IDENT_in_createWindowExpr581 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000003L,0x0000000000000090L,0x0000000200010000L});
    public static final BitSet FOLLOW_viewListExpr_in_createWindowExpr584 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000003L,0x0000000000000090L,0x0000000200010000L});
    public static final BitSet FOLLOW_RETAINUNION_in_createWindowExpr588 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000003L,0x0000000000000090L,0x0000000200010000L});
    public static final BitSet FOLLOW_RETAININTERSECTION_in_createWindowExpr591 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000003L,0x0000000000000090L,0x0000000200010000L});
    public static final BitSet FOLLOW_createSelectionList_in_createWindowExpr605 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_IDENT_in_createIndexExpr670 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_createIndexExpr672 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000400000000000L});
    ...
    public static final BitSet FOLLOW_createSelectionListElement_in_createSelectionList710 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000200000L,0x0000000000000001L});
    public static final BitSet FOLLOW_createSelectionListElement_in_createSelectionList713 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000200000L,0x0000000000000001L});
    public static final BitSet FOLLOW_CREATE_COL_TYPE_LIST_in_createColTypeList732 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_createColTypeListElement_in_createColTypeList734 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000400000000L});
    public static final BitSet FOLLOW_createColTypeListElement_in_createColTypeList737 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000400000000L});
    public static final BitSet FOLLOW_CREATE_COL_TYPE_in_createColTypeListElement752 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_createColTypeListElement754 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_createColTypeListElement756 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_eventPropertyExpr_in_createSelectionListElement803 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_createSelectionListElement807 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_constant_in_createSelectionListElement829 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_CLASS_IDENT_in_createVariableExpr870 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_createVariableExpr872 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_IDENT_in_createSchemaExpr897 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000003L,0x0000000000000090L,0x0000700200010000L});
    public static final BitSet FOLLOW_variantList_in_createSchemaExpr900 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000300000000000L});
    public static final BitSet FOLLOW_createColTypeList_in_createSchemaExpr902 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000300000000000L});
    ...
    public static final BitSet FOLLOW_IDENT_in_createSchemaExpr928 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000400000000000L});
    ...
    public static final BitSet FOLLOW_set_in_variantList953 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000010L,0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_insertIntoExpr_in_selectExpr971 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000200000100000L});
    public static final BitSet FOLLOW_selectClause_in_selectExpr977 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000800000L});
    public static final BitSet FOLLOW_fromClause_in_selectExpr982 = new BitSet(new long[]{0x0000000000000002L,0x0000004800000000L,0x0000178060000C00L});
    public static final BitSet FOLLOW_matchRecogClause_in_selectExpr987 = new BitSet(new long[]{0x0000000000000002L,0x0000000800000000L,0x0000178060000C00L});
    public static final BitSet FOLLOW_whereClause_in_selectExpr994 = new BitSet(new long[]{0x0000000000000002L,0x0000000800000000L,0x0000178060000800L});
    public static final BitSet FOLLOW_groupByClause_in_selectExpr1002 = new BitSet(new long[]{0x0000000000000002L,0x0000000800000000L,0x0000178040000800L});
    public static final BitSet FOLLOW_havingClause_in_selectExpr1009 = new BitSet(new long[]{0x0000000000000002L,0x0000000800000000L,0x0000178040000000L});
    public static final BitSet FOLLOW_outputLimitExpr_in_selectExpr1016 = new BitSet(new long[]{0x0000000000000002L,0x0000000800000000L,0x0000000040000000L});
    ...
    public static final BitSet FOLLOW_set_in_insertIntoExpr1049 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_insertIntoExpr1058 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000400000000000L});
    ...
    public static final BitSet FOLLOW_IDENT_in_exprCol1082 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_exprCol1085 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_SELECTION_EXPR_in_selectClause1103 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_selectClause1105 = new BitSet(new long[]{0x0000400000000000L,0x0000000000000000L,0x0000000000600000L,0x0000000000000001L});
    public static final BitSet FOLLOW_DISTINCT_in_selectClause1118 = new BitSet(new long[]{0x0000400000000000L,0x0000000000000000L,0x0000000000600000L,0x0000000000000001L});
    public static final BitSet FOLLOW_selectionList_in_selectClause1121 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_streamExpression_in_fromClause1135 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000800000L});
    public static final BitSet FOLLOW_streamExpression_in_fromClause1138 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x000000001E800000L});
    public static final BitSet FOLLOW_outerJoin_in_fromClause1141 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x000000001E800000L});
    public static final BitSet FOLLOW_FOR_in_forExpr1161 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_forExpr1163 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_forExpr1165 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_MATCH_RECOGNIZE_in_matchRecogClause1184 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchRecogPartitionBy_in_matchRecogClause1186 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_matchRecogMeasures_in_matchRecogClause1193 = new BitSet(new long[]{0x0000800000000000L,0x0000000000000000L,0x0000000000000000L,0x2100000000000000L});
    public static final BitSet FOLLOW_ALL_in_matchRecogClause1199 = new BitSet(new long[]{0x0000800000000000L,0x0000000000000000L,0x0000000000000000L,0x2100000000000000L});
    public static final BitSet FOLLOW_matchRecogMatchesAfterSkip_in_matchRecogClause1205 = new BitSet(new long[]{0x0000800000000000L,0x0000000000000000L,0x0000000000000000L,0x2100000000000000L});
    public static final BitSet FOLLOW_matchRecogPattern_in_matchRecogClause1211 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0xC000000000000000L});
    public static final BitSet FOLLOW_matchRecogMatchesInterval_in_matchRecogClause1217 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0xC000000000000000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_matchRecogPartitionBy1243 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_IDENT_in_matchRecogMatchesAfterSkip1262 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_matchRecogMatchesAfterSkip1264 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_matchRecogMatchesAfterSkip1266 = new BitSet(new long[]{0x0020000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_set_in_matchRecogMatchesAfterSkip1268 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_IDENT_in_matchRecogMatchesInterval1291 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0004000000000000L});
    ...
    public static final BitSet FOLLOW_matchRecogMeasureListElement_in_matchRecogMeasures1311 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000004L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_matchRecogMeasureListElement1330 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_matchRecogPatternAlteration_in_matchRecogPattern1354 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0C00000000000000L});
    ...
    public static final BitSet FOLLOW_matchRecogPatternConcat_in_matchRecogPatternAlteration1379 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0400000000000000L});
    public static final BitSet FOLLOW_matchRecogPatternConcat_in_matchRecogPatternAlteration1381 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0400000000000000L});
    ...
    public static final BitSet FOLLOW_matchRecogPatternUnary_in_matchRecogPatternConcat1401 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x1200000000000000L});
    ...
    public static final BitSet FOLLOW_matchRecogPatternAlteration_in_matchRecogPatternNested1438 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x000000000000D000L});
    ...
    public static final BitSet FOLLOW_IDENT_in_matchRecogPatternAtom1471 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x000000000000D000L});
    public static final BitSet FOLLOW_set_in_matchRecogPatternAtom1475 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000008000L});
    ...
    public static final BitSet FOLLOW_matchRecogDefineItem_in_matchRecogDefine1511 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000001L});
    ...
    public static final BitSet FOLLOW_IDENT_in_matchRecogDefineItem1530 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_matchRecogDefineItem1532 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_selectionListElement_in_selectionList1549 = new BitSet(new long[]{0x0000400000000002L,0x0000000000000000L,0x0000000000600000L,0x0000000000000001L});
    public static final BitSet FOLLOW_selectionListElement_in_selectionList1552 = new BitSet(new long[]{0x0000400000000002L,0x0000000000000000L,0x0000000000600000L,0x0000000000000001L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_selectionListElement1580 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_IDENT_in_selectionListElement1599 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1637 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1640 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1644 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1647 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_RIGHT_OUTERJOIN_EXPR_in_outerJoinIdent1662 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1664 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1667 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1671 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1674 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_FULL_OUTERJOIN_EXPR_in_outerJoinIdent1689 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1691 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1694 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1698 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1701 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_INNERJOIN_EXPR_in_outerJoinIdent1716 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1718 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1721 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1725 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_outerJoinIdent1728 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_STREAM_EXPR_in_streamExpression1749 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventFilterExpr_in_streamExpression1752 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000003L,0x0000000000000080L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_patternInclusionExpression_in_streamExpression1756 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000003L,0x0000000000000080L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_databaseJoinExpression_in_streamExpression1760 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000003L,0x0000000000000080L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_methodJoinExpression_in_streamExpression1764 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000003L,0x0000000000000080L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_viewListExpr_in_streamExpression1768 = new BitSet(new long[]{0x8000000000000008L,0x0000000000000003L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_IDENT_in_eventFilterExpr1808 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_eventFilterExpr1811 = new BitSet(new long[]{0x0000000037CC23C8L,0x0080000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_propertyExpression_in_eventFilterExpr1813 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_eventFilterExpr1817 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_propertyExpressionAtom_in_propertyExpression1839 = new BitSet(new long[]{0x0000000000000008L,0x0100000000000000L});
    ...
    public static final BitSet FOLLOW_propertySelectionListElement_in_propertyExpressionAtom1860 = new BitSet(new long[]{0x0000000000000000L,0x0E00000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_propertyExpressionAtom1863 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000400L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_propertyExpressionAtom1866 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_propertySelectionListElement1904 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_IDENT_in_propertySelectionListElement1923 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_IDENT_in_databaseJoinExpression1968 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000060000L});
    public static final BitSet FOLLOW_set_in_databaseJoinExpression1970 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000060000L});
    ...
    public static final BitSet FOLLOW_IDENT_in_methodJoinExpression2001 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_methodJoinExpression2003 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_methodJoinExpression2006 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_viewExpr_in_viewListExpr2020 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000080L});
    public static final BitSet FOLLOW_viewExpr_in_viewListExpr2023 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000080L});
    public static final BitSet FOLLOW_VIEW_EXPR_in_viewExpr2040 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_viewExpr2042 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_viewExpr2044 = new BitSet(new long[]{0x0020000037CC23C8L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExprWithTime_in_viewExpr2047 = new BitSet(new long[]{0x0020000037CC23C8L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_groupByClause2091 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_groupByClause2094 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_ORDER_BY_EXPR_in_orderByClause2112 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_orderByElement_in_orderByClause2114 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000080000000L});
    public static final BitSet FOLLOW_orderByElement_in_orderByClause2117 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000080000000L});
    ...
    public static final BitSet FOLLOW_set_in_outputLimitExpr2186 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0007800000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_set_in_outputLimitExpr2222 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0004000000000000L});
    ...
    public static final BitSet FOLLOW_set_in_outputLimitExpr2253 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000080000000000L});
    ...
    public static final BitSet FOLLOW_set_in_outputLimitExpr2284 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_outputLimitExpr2295 = new BitSet(new long[]{0x0000000000000008L,0x0000080000000000L,0x0000000000000000L,0x0000000002380000L});
    ...
    public static final BitSet FOLLOW_timePeriod_in_outputLimitAfter2332 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0007800000000000L});
    ...
    public static final BitSet FOLLOW_number_in_rowLimitClause2354 = new BitSet(new long[]{0x0000000000000008L,0x0000001000000000L,0x0000000000000000L,0x0007800000000000L,0x0000000000000030L});
    public static final BitSet FOLLOW_IDENT_in_rowLimitClause2356 = new BitSet(new long[]{0x0000000000000008L,0x0000001000000000L,0x0000000000000000L,0x0007800000000000L,0x0000000000000030L});
    public static final BitSet FOLLOW_number_in_rowLimitClause2360 = new BitSet(new long[]{0x0000000000000008L,0x0000001000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_IDENT_in_rowLimitClause2362 = new BitSet(new long[]{0x0000000000000008L,0x0000001000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2389 = new BitSet(new long[]{0x0020000037CC23C0L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2391 = new BitSet(new long[]{0x0020000037CC23C0L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2393 = new BitSet(new long[]{0x0020000037CC23C0L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2395 = new BitSet(new long[]{0x0020000037CC23C0L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExprWithTime_in_crontabLimitParameterSet2397 = new BitSet(new long[]{0x0020000037CC23C8L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_relationalExprValue2484 = new BitSet(new long[]{0x0003800037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_relationalExprValue2494 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_relationalExprValue2509 = new BitSet(new long[]{0x0000000037CC23C2L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011FCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_relationalExprValue2518 = new BitSet(new long[]{0x0000000037CC23C2L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2551 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2553 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2556 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_EVAL_AND_EXPR_in_evalExprChoice2570 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2572 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2574 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2577 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_EVAL_EQUALS_EXPR_in_evalExprChoice2591 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2593 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2609 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_set_in_evalExprChoice2627 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011FCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2636 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_set_in_evalExprChoice2658 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011FCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_evalExprChoice2667 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_numericParameterList_in_valueExprWithTime2883 = new BitSet(new long[]{0x0000000000000008L,0x0000A00000000000L,0x0000000000000000L,0x003F800000000000L});
    ...
    public static final BitSet FOLLOW_constant_in_rangeOperator2946 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L,0x003F800000001000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_rangeOperator2949 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L,0x003F800000001000L});
    public static final BitSet FOLLOW_substitution_in_rangeOperator2952 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L,0x003F800000001000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_subSelectInExpr3134 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_subSelectInExpr3150 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000200L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_subQueryExpr3189 = new BitSet(new long[]{0x0000400000000000L,0x0000000000000000L,0x0000000000600000L,0x0000000000000001L});
    public static final BitSet FOLLOW_selectionListElement_in_subQueryExpr3192 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000800000L});
    public static final BitSet FOLLOW_subSelectFilterExpr_in_subQueryExpr3194 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_eventFilterExpr_in_subSelectFilterExpr3217 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000003L,0x0000000000000080L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_viewListExpr_in_subSelectFilterExpr3220 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000003L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_caseExpr3255 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_CASE2_in_caseExpr3268 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_caseExpr3271 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_IN_SET_in_inExpr3291 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3293 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000500L});
    public static final BitSet FOLLOW_set_in_inExpr3295 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3301 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987A00L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3304 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987A00L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_inExpr3325 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000500L});
    public static final BitSet FOLLOW_set_in_inExpr3327 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3333 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987A00L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3336 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987A00L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_inExpr3357 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000500L});
    public static final BitSet FOLLOW_set_in_inExpr3359 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3365 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3367 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000A00L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_inExpr3386 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000500L});
    public static final BitSet FOLLOW_set_in_inExpr3388 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3394 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_inExpr3396 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000A00L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3423 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3425 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3440 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3442 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_betweenExpr3445 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_LIKE_in_likeExpr3465 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3467 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3469 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3487 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_likeExpr3489 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_regExpExpr3513 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_regExpExpr3528 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3552 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3570 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3589 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3610 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3628 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3646 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3664 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_DISTINCT_in_builtinFunc3682 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3700 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3702 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3705 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_PREVIOUS_in_builtinFunc3720 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3722 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_NUM_INT_in_builtinFunc3741 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3758 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_builtinFunc3760 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_builtinFunc3763 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_CAST_in_builtinFunc3777 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_builtinFunc3779 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arrayExpr3830 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_PLUS_in_arithmeticExpr3851 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3853 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3869 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3885 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3900 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3916 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3931 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3946 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3961 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    ...
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3977 = new BitSet(new long[]{0x0000000037CC23C0L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3979 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_arithmeticExpr3982 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_LIB_FUNCTION_in_libFunc4003 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_libFunc4006 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_libFunc4010 = new BitSet(new long[]{0x0000400037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_DISTINCT_in_libFunc4013 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_libFunc4018 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_annotation_in_startPatternExpressionRule4038 = new BitSet(new long[]{0x000000000000D800L,0x001A000000000000L,0x0000000000000060L,0x0000001010000000L});
    ...
    public static final BitSet FOLLOW_distinctExpressions_in_exprChoice4089 = new BitSet(new long[]{0x000000000000D800L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    ...
    public static final BitSet FOLLOW_exprChoice_in_exprChoice4123 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_exprChoice4125 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_exprChoice4127 = new BitSet(new long[]{0x0020000037CC23C8L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExprWithTime_in_exprChoice4129 = new BitSet(new long[]{0x0020000037CC23C8L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_MATCH_UNTIL_EXPR_in_exprChoice4143 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRange_in_exprChoice4145 = new BitSet(new long[]{0x000000000000D800L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_exprChoice_in_exprChoice4148 = new BitSet(new long[]{0x000000000000D808L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_exprChoice_in_exprChoice4150 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PATTERN_EVERY_DISTINCT_EXPR_in_distinctExpressions4171 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_distinctExpressions4173 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_FOLLOWED_BY_EXPR_in_patternOp4192 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4194 = new BitSet(new long[]{0x000000000000D800L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4196 = new BitSet(new long[]{0x000000000000D808L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4199 = new BitSet(new long[]{0x000000000000D808L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_OR_EXPR_in_patternOp4215 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4217 = new BitSet(new long[]{0x000000000000D800L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4219 = new BitSet(new long[]{0x000000000000D808L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4222 = new BitSet(new long[]{0x000000000000D808L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_AND_EXPR_in_patternOp4238 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4240 = new BitSet(new long[]{0x000000000000D800L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4242 = new BitSet(new long[]{0x000000000000D808L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_exprChoice_in_patternOp4245 = new BitSet(new long[]{0x000000000000D808L,0x001A000000000000L,0x0000000000000060L,0x0000000010000000L});
    public static final BitSet FOLLOW_patternFilterExpr_in_atomicExpr4264 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OBSERVER_EXPR_in_atomicExpr4276 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_atomicExpr4278 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_IDENT_in_atomicExpr4280 = new BitSet(new long[]{0x0020000037CC23C8L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExprWithTime_in_atomicExpr4282 = new BitSet(new long[]{0x0020000037CC23C8L,0x0001E00000001EE0L,0x1E0D80010007E000L,0x003F818800001DDCL,0x0000000077987000L});
    public static final BitSet FOLLOW_PATTERN_FILTER_EXPR_in_patternFilterExpr4302 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_patternFilterExpr4304 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_CLASS_IDENT_in_patternFilterExpr4307 = new BitSet(new long[]{0x0000000037CC23C8L,0x0080000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_propertyExpression_in_patternFilterExpr4309 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_patternFilterExpr4313 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_MATCH_UNTIL_RANGE_CLOSED_in_matchUntilRange4331 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4333 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0040000000000000L,0x0000000200000000L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4335 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCH_UNTIL_RANGE_BOUNDED_in_matchUntilRange4343 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4345 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCH_UNTIL_RANGE_HALFCLOSED_in_matchUntilRange4353 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4355 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MATCH_UNTIL_RANGE_HALFOPEN_in_matchUntilRange4362 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_matchUntilRangeParam_in_matchUntilRange4364 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_matchUntilRangeParam0 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EVENT_FILTER_PARAM_in_filterParam4393 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_filterParam4395 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_valueExpr_in_filterParam4398 = new BitSet(new long[]{0x0000000037CC23C8L,0x0000000000001CE0L,0x1E0980010007E000L,0x003F8180000011DCL,0x0000000077987000L});
    public static final BitSet FOLLOW_EQUALS_in_filterParamComparator4414 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4416 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_EQUAL_in_filterParamComparator4423 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4425 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_LT_in_filterParamComparator4432 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4434 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_LE_in_filterParamComparator4441 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4443 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GT_in_filterParamComparator4450 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4452 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GE_in_filterParamComparator4459 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_filterAtom_in_filterParamComparator4461 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_RANGE_in_filterParamComparator4468 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4470 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4477 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4480 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4484 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4487 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4490 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_NOT_RANGE_in_filterParamComparator4501 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4503 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4510 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4513 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4517 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4520 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4523 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_IN_in_filterParamComparator4534 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4536 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4543 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4546 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4550 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4553 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4557 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_NOT_IN_in_filterParamComparator4568 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4570 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4577 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4580 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4584 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4587 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L,0x0000000000000A00L});
    public static final BitSet FOLLOW_set_in_filterParamComparator4591 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_BETWEEN_in_filterParamComparator4602 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4605 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4608 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4612 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4615 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_FILTER_NOT_BETWEEN_in_filterParamComparator4623 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4626 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4629 = new BitSet(new long[]{0x0000000000000000L,0x1000000000000000L,0x0000000000000000L,0x003F800000000000L});
    public static final BitSet FOLLOW_constant_in_filterParamComparator4633 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterParamComparator4636 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_constant_in_filterAtom4650 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_filterIdentifier_in_filterAtom4656 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EVENT_FILTER_IDENT_in_filterIdentifier4667 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_filterIdentifier4669 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_eventPropertyExpr_in_filterIdentifier4671 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_EXPR_in_eventPropertyExpr4690 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_eventPropertyAtomic_in_eventPropertyExpr4692 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000007E00000000L});
    public static final BitSet FOLLOW_eventPropertyAtomic_in_eventPropertyExpr4695 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000007E00000000L});
    public static final BitSet FOLLOW_EVENT_PROP_SIMPLE_in_eventPropertyAtomic4714 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4716 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_INDEXED_in_eventPropertyAtomic4723 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4725 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000200000000L});
    public static final BitSet FOLLOW_NUM_INT_in_eventPropertyAtomic4727 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_MAPPED_in_eventPropertyAtomic4734 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4736 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000060000L});
    public static final BitSet FOLLOW_set_in_eventPropertyAtomic4738 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_DYNAMIC_SIMPLE_in_eventPropertyAtomic4751 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4753 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_DYNAMIC_INDEXED_in_eventPropertyAtomic4760 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4762 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000200000000L});
    public static final BitSet FOLLOW_NUM_INT_in_eventPropertyAtomic4764 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_EVENT_PROP_DYNAMIC_MAPPED_in_eventPropertyAtomic4771 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_eventPropertyAtomic4773 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000060000L});
    public static final BitSet FOLLOW_set_in_eventPropertyAtomic4775 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_TIME_PERIOD_in_timePeriod4800 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_timePeriodDef_in_timePeriod4802 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_dayPart_in_timePeriodDef4818 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x01E0000000000000L});
    public static final BitSet FOLLOW_hourPart_in_timePeriodDef4821 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x01C0000000000000L});
    public static final BitSet FOLLOW_minutePart_in_timePeriodDef4826 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0180000000000000L});
    public static final BitSet FOLLOW_secondPart_in_timePeriodDef4831 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0100000000000000L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4836 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_hourPart_in_timePeriodDef4843 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x01C0000000000000L});
    public static final BitSet FOLLOW_minutePart_in_timePeriodDef4846 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0180000000000000L});
    public static final BitSet FOLLOW_secondPart_in_timePeriodDef4851 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0100000000000000L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4856 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_minutePart_in_timePeriodDef4863 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0180000000000000L});
    public static final BitSet FOLLOW_secondPart_in_timePeriodDef4866 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0100000000000000L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4871 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_secondPart_in_timePeriodDef4878 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0100000000000000L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4881 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_millisecondPart_in_timePeriodDef4888 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DAY_PART_in_dayPart4902 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_dayPart4904 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_HOUR_PART_in_hourPart4919 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_hourPart4921 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MINUTE_PART_in_minutePart4936 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_minutePart4938 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SECOND_PART_in_secondPart4953 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_secondPart4955 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_MILLISECOND_PART_in_millisecondPart4970 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_valueExpr_in_millisecondPart4972 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SUBSTITUTION_in_substitution4987 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INT_TYPE_in_constant5003 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LONG_TYPE_in_constant5012 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FLOAT_TYPE_in_constant5021 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DOUBLE_TYPE_in_constant5030 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_TYPE_in_constant5046 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_BOOL_TYPE_in_constant5062 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NULL_TYPE_in_constant5075 = new BitSet(new long[]{0x0000000000000002L});
