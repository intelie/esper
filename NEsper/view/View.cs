...
namespace net.esper.view
{
    ...
    public interface View : EventCollection, Viewable
	{
		...
		/// <summary> Return null if the view will accept being attached to a particular object.</summary>
		/// <param name="parentViewable">is the potential parent for this view
		/// </param>
		/// <returns> null if this view can successfully attach to the parent, an error message if it cannot.
		/// </returns>
		String AttachesTo(Viewable parentViewable);
		
		/// <summary> Notify that data has been added or removed from the Viewable parent.
