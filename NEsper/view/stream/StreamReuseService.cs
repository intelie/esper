using System;
using EventStream = net.esper.view.EventStream;
using FilterSpec = net.esper.filter.FilterSpec;
using FilterService = net.esper.filter.FilterService;
namespace net.esper.view.stream
{
	...
	public interface StreamReuseService
	{
		...
		/// </summary>
		/// <param name="filterSpec">event filter definition
		/// </param>
		/// <param name="filterService">filter service to activate filter if not already active
		/// </param>
		/// <returns> event stream representing active filter
		/// </returns>
		...
		/// </summary>
		/// <param name="filterSpec">is the event filter definition associated with the event stream to be dropped
		/// </param>
		/// <param name="filterService">to be used to deactivate filter when the last event stream is dropped
		/// </param>
