...
namespace net.esper.eql.core
{
    ...
    public interface StreamTypeService
	{
		...
		/// <summary> Returns the offset of the stream and the type of the property for the given property name,
		...
		/// </summary>
		/// <param name="propertyName">- property name in event
		/// </param>
		/// <returns> descriptor with stream number, property type and property name
		/// </returns>
		...
		/// </summary>
		/// <param name="streamName">- name of stream, required
		/// </param>
		/// <param name="propertyName">- property name in event, , required
		/// </param>
		/// <returns> descriptor with stream number, property type and property name
		/// </returns>
		/// <throws>  PropertyNotFoundException to indicate property could not be resolved </throws>
		...
		/// </summary>
		/// <param name="streamAndPropertyName">- stream name and property name (e.g. s0.p0) or just a property name (p0)
		/// </param>
		/// <returns> descriptor with stream number, property type and property name
		/// </returns>
		/// <throws>  DuplicatePropertyException to indicate property was found twice </throws>
