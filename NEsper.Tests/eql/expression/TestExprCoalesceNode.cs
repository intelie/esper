...
namespace net.esper.eql.expression
{
	...
	public class TestExprCoalesceNode 
	{
		...
		public virtual void  setUp()
		{
			...
			coalesceNodes[0].AddChildNode(new SupportExprNode((Object) null, typeof(Int64)));
			...
			coalesceNodes[3].AddChildNode(new SupportExprNode((Object) null, typeof(System.Char)));
			coalesceNodes[3].AddChildNode(new SupportExprNode((Object) null, typeof(char)));
			coalesceNodes[3].AddChildNode(new SupportExprNode('b', typeof(System.Char)));
		...
		public virtual void  testGetType()
		{
			...
			Assert.AreEqual(typeof(Int64), coalesceNodes[0].ReturnType);
			Assert.AreEqual(typeof(String), coalesceNodes[1].ReturnType);
			Assert.AreEqual(typeof(bool), coalesceNodes[2].ReturnType);
			Assert.AreEqual(typeof(System.Char), coalesceNodes[3].ReturnType);
