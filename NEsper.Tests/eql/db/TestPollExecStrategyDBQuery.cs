...
namespace net.esper.eql.db
{
	...
	public class TestPollExecStrategyDBQuery
	{
		...
		public virtual void setUp()
		{
			...
			propertiesOut.Put( "myvarchar", new DBOutputTypeDesc( (int) System.Data.OleDb.OleDbType.VarChar, null ) );

			dbPollExecStrategy = new PollExecStrategyDBQuery( SupportEventAdapterService.Service, resultEventType, connectionCache, sql, propertiesOut );
		}
