...
namespace net.esper.regression.view
{
	...
	public class TestGroupByCount 
	{
		...
		private void  runAssertion()
		{
			...
			Assert.AreEqual(typeof(Int64), selectTestView.EventType.GetPropertyType("countAll"));
			Assert.AreEqual(typeof(Int64), selectTestView.EventType.GetPropertyType("countDistVol"));
			Assert.AreEqual(typeof(Int64), selectTestView.EventType.GetPropertyType("countVol"));
