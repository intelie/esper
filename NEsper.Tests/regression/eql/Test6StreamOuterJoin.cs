	...
	public class Test6StreamOuterJoin 
	{
		...
		public virtual void testRoot_s0()
		{
			...
			*/
			String joinStatement = 
				"select * from " + 
				EVENT_S0 + ".win:length(1000) as s0 " + " right outer join " + 
				...
				EVENT_S4 + ".win:length(1000) as s4 on s2.p20 = s4.p40 " + " right outer join " + 
		...
		public virtual void  testRoot_s1()
		{
			...
			*/
			String joinStatement = 
				"select * from " + 
				EVENT_S1 + ".win:length(1000) as s1 " + " left outer join " + 
				...
				EVENT_S4 + ".win:length(1000) as s4 on s2.p20 = s4.p40 ";
		...
		public virtual void  testRoot_s2()
		{
			...
			*/
			String joinStatement = 
				"select * from " + 
				EVENT_S2 + ".win:length(1000) as s2 " + " left outer join " + 
				EVENT_S0 + ".win:length(1000) as s0 on s0.p00 = s2.p20 " + " right outer join " + 
				EVENT_S1 + ".win:length(1000) as s1 on s0.p00 = s1.p10 " + " right outer join " + 
				EVENT_S3 + ".win:length(1000) as s3 on s1.p10 = s3.p30 " + " right outer join " + 
				EVENT_S4 + ".win:length(1000) as s4 on s2.p20 = s4.p40 " + " right outer join " + 
				EVENT_S5 + ".win:length(1000) as s5 on s2.p20 = s5.p50 ";
		...
		public virtual void  testRoot_s3()
		{
			...
			*/
			String joinStatement = 
				...
				EVENT_S1 + ".win:length(1000) as s1 on s1.p10 = s3.p30 " + " left outer join " +
				EVENT_S0 + ".win:length(1000) as s0 on s0.p00 = s1.p10 " + " right outer join " +
				EVENT_S2 + ".win:length(1000) as s2 on s0.p00 = s2.p20 " + " right outer join " + 
				EVENT_S5 + ".win:length(1000) as s5 on s2.p20 = s5.p50 " + " right outer join " + 
				EVENT_S4 + ".win:length(1000) as s4 on s2.p20 = s4.p40 ";
		...
		public virtual void  testRoot_s4()
		{
			...
			*/
			String joinStatement = 
				"select * from " +
				EVENT_S4 + ".win:length(1000) as s4 " + " left outer join " + 
				EVENT_S2 + ".win:length(1000) as s2 on s2.p20 = s4.p40 " + " right outer join " +
		...
		public virtual void  testRoot_s5()
		{
			...
			*/
			String joinStatement = 
				"select * from " + 
				EVENT_S5 + ".win:length(1000) as s5 " + " left outer join " +
				EVENT_S2 + ".win:length(1000) as s2 on s2.p20 = s5.p50 " + " right outer join " +
				EVENT_S4 + ".win:length(1000) as s4 on s2.p20 = s4.p40 " + " left outer join " + 
				EVENT_S0 + ".win:length(1000) as s0 on s0.p00 = s2.p20 " + " right outer join " + 
				EVENT_S1 + ".win:length(1000) as s1 on s0.p00 = s1.p10 " + " right outer join " + 
				EVENT_S3 + ".win:length(1000) as s3 on s1.p10 = s3.p30 ";
