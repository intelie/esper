    ...
    public class TestTimerAtObserver : SupportBeanConstants
    {
        ...
        public virtual void testOp()
        {
            ...
            */
            ...
            testCase = new EventExpressionCase("b=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_B_CLASS + "(id='B3') -> timer:at(20, 9, *, *, *, *)");
            testCaseList.AddTest(testCase);

            testCase = new EventExpressionCase("b=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_B_CLASS + "(id='B3') -> timer:at(45, 9, *, *, *, *)");
            testCase.Add("G1", "b", testData.getEvent("B3"));
            testCaseList.AddTest(testCase);

            testCase = new EventExpressionCase("timer:at(59, 8, *, *, *, 59) -> d=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_D_CLASS);
            testCase.Add("D1", "d", testData.getEvent("D1"));
            testCaseList.AddTest(testCase);

            testCase = new EventExpressionCase("timer:at(*, 9, *, *, *, 59) -> d=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_D_CLASS);
            testCase.Add("D2", "d", testData.getEvent("D2"));
            testCaseList.AddTest(testCase);

            testCase = new EventExpressionCase("timer:at(22, 8, *, *, *) -> b=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_B_CLASS + "(id='B3') -> timer:at(55, *, *, *, *)");
            testCase.Add("D3", "b", testData.getEvent("B3"));
            testCaseList.AddTest(testCase);

            testCase = new EventExpressionCase("timer:at(40, *, *, *, *, 1) and b=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_B_CLASS);
            testCase.Add("A2", "b", testData.getEvent("B1"));
            testCaseList.AddTest(testCase);

            testCase = new EventExpressionCase("timer:at(40, 9, *, *, *, 1) or d=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_D_CLASS + "(id=\"D3\")");
            testCase.Add("G1");
            testCaseList.AddTest(testCase);

            testCase = new EventExpressionCase("timer:at(22, 8, *, *, *) -> b=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_B_CLASS + "() -> timer:at(55, 8, *, *, *)");
            ...
            testCase = new EventExpressionCase("timer:at(40, 8, *, *, *, 1) and b=" + net.esper.support.bean.SupportBeanConstants_Fields.EVENT_B_CLASS);
            testCase.Add("A2", "b", testData.getEvent("B1"));
            testCaseList.AddTest(testCase);
