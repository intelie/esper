...
namespace net.esper.view.stat
{
	...
	{
		//UPGRADE_NOTE: readonly was removed from the declaration of 'PRECISION_DIGITS '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
