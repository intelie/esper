...
namespace net.esper.view.stat
{
	...
	public class TestCorrelationViewFactory
	{
	    ...
	    public void testCanReuse()
	    {
	        ...
	        Assert.IsFalse(factory.CanReuse(new CorrelationView(SupportStatementContextFactory.MakeContext(), "a", "c")));
	        Assert.IsFalse(factory.CanReuse(new CorrelationView(SupportStatementContextFactory.MakeContext(), "x", "b")));
	        Assert.IsTrue(factory.CanReuse(new CorrelationView(SupportStatementContextFactory.MakeContext(), "a", "b")));
	    }
	    ...
	    public void testAttaches()
	    {
            ...
            Assert.AreEqual(typeof(double), factory.EventType.GetPropertyType(ViewFieldEnum.CORRELATION__CORRELATION.Name));
