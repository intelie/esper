...
public class TestSocketAdapterObject extends TestCase
{
    ...
    public void testSendObject() throws Exception
    {
        ...
        Thread.sleep(200);
        ArrayAssertionUtil.assertProps(listener.assertOneGetNewAndReset(), fields, new Object[] {"E3", 30});
        ...
        Thread.sleep(200);
        ArrayAssertionUtil.assertProps(listener.assertOneGetNewAndReset(), fields, new Object[] {"E4", 40});

        clientOne.send(new SupportBean("E5", 50));
        Thread.sleep(200);
        ArrayAssertionUtil.assertProps(listener.assertOneGetNewAndReset(), fields, new Object[] {"E5", 50});

        clientOne.send(getMapEvent(mapTypeName, "E6", 60));
        Thread.sleep(200);
        ArrayAssertionUtil.assertProps(listener.assertOneGetNewAndReset(), fields, new Object[] {"E6", 60});
