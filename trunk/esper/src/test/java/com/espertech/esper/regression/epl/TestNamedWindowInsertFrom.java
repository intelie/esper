...
public class TestNamedWindowInsertFrom extends TestCase
{
    ...
    public void testInsertWhere()
    {
        ...
        ArrayAssertionUtil.assertProps(listeners[2].assertOneGetNewAndReset(), fields, new Object[] {"B9"});
        ...
        ArrayAssertionUtil.assertProps(listeners[0].assertOneGetNewAndReset(), fields, new Object[] {"A8"});
        ...
        ArrayAssertionUtil.assertProps(listeners[3].assertOneGetNewAndReset(), fields, new Object[] {"C7"});
        ...
        ArrayAssertionUtil.assertProps(listeners[4].assertOneGetNewAndReset(), fields, new Object[] {"D6"});
