...
public class Test4StreamOuterInnerJoin extends TestCase
{
    ...
    {
        String joinStatement =  "select * from S3 s3 " +
                                " inner join S2 s2 on s3.p30 = s2.p20 " +
                                " full outer join S1 s1 on s2.p20 = s1.p10 " +
                                " inner join S0 s0 on s1.p10 = s0.p00";
    ...
    {
        String joinStatement =  "select * from S0 s0 " +
                                " inner join S1 s1 on s0.p00 = s1.p10 " +
                                " full outer join S2 s2 on s1.p10 = s2.p20 " +
                                " inner join S3 s3 on s2.p20 = s3.p30";
    ...
    {
        String joinStatement =  "select * from S3 s3 " +
                                " full outer join S2 s2 on s3.p30 = s2.p20 " +
                                " full outer join S1 s1 on s2.p20 = s1.p10 " +
                                " inner join S0 s0 on s1.p10 = s0.p00";
    ...
    public void testFullSidedJoinVariantOne()
    {
        String joinStatement =  "select * from S0 s0 " +
                                " inner join S1 s1 on s0.p00 = s1.p10 " +
                                " full outer join S2 s2 on s1.p10 = s2.p20 " +
                                " full outer join S3 s3 on s2.p20 = s3.p30";
    ...
    {
        String joinStatement =  "select * from S0 s0 " +
                                " left outer join S1 s1 on s0.p00 = s1.p10 " +
                                " full outer join S2 s2 on s0.p00 = s2.p20 " +
                                " inner join S3 s3 on s0.p00 = s3.p30";
    ...
    {
        String joinStatement =  "select * from S3 s3 " +
                                " inner join S0 s0 on s0.p00 = s3.p30 " +
                                " full outer join S2 s2 on s0.p00 = s2.p20 " +
                                " left outer join S1 s1 on s1.p10 = s0.p00";
