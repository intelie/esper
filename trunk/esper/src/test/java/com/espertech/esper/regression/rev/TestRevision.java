...
public class TestRevision extends TestCase
{
    ...
    public void testRevision()
    {
        ...
        EventBean f0 = new RevisionEventBean(revisionEventType, fullEventBean, holders);
        ...
        EventBean d1 = new RevisionEventBean(revisionEventType, fullEventBean, holders);
        ...
        EventBean d2 = new RevisionEventBean(revisionEventType, fullEventBean, holders);
        ...
        EventBean d3 = new RevisionEventBean(revisionEventType, fullEventBean, holders);
        ...
        EventBean d4 = new RevisionEventBean(revisionEventType, fullEventBean, holders);
        ...
        EventBean d5 = new RevisionEventBean(revisionEventType, fullEventBean, holders);
