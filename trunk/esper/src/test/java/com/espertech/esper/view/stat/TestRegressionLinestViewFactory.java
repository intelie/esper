...
public class TestRegressionLinestViewFactory extends TestCase
{
    ...
    public void testCanReuse() throws Exception
    {
        ...
        assertFalse(factory.canReuse(new RegressionLinestView(SupportStatementContextFactory.makeContext(), SupportExprNodeFactory.makeIdentNode("a"), SupportExprNodeFactory.makeIdentNode("c"))));
        assertFalse(factory.canReuse(new RegressionLinestView(SupportStatementContextFactory.makeContext(), SupportExprNodeFactory.makeIdentNode("x"), SupportExprNodeFactory.makeIdentNode("b"))));
        assertTrue(factory.canReuse(new RegressionLinestView(SupportStatementContextFactory.makeContext(), SupportExprNodeFactory.makeIdentNode("a"), SupportExprNodeFactory.makeIdentNode("b"))));
    }
