...
public class TestFromClauseMethod extends TestCase
{
    ...
    public void testArrayNoArg()
    {
        String joinStatement = "select id, string from " +
                ...
                "method:net.esper.support.eql.SupportStaticMethodLib.fetchArrayNoArg";
        EPStatement stmt = epService.getEPAdministrator().createEQL(joinStatement);
        tryArrayNoArg(stmt);
    ...
    public void testArrayWithArg()
    {
        String joinStatement = "select id, string from " +
                SupportBean.class.getName() + "().win:length(3) as s1, " +
                " method:net.esper.support.eql.SupportStaticMethodLib.fetchArrayGen(intPrimitive)";
        EPStatement stmt = epService.getEPAdministrator().createEQL(joinStatement);
        tryArrayWithArg(stmt);

        joinStatement = "select id, string from " +
                "method:net.esper.support.eql.SupportStaticMethodLib.fetchArrayGen(intPrimitive) as s0, " +
    ...
    public void testObjectNoArg()
    {
        String joinStatement = "select id, string from " +
                SupportBean.class.getName() + "().win:length(3) as s1, " +
                " method:net.esper.support.eql.SupportStaticMethodLib.fetchObjectNoArg()";
    ...
    public void testObjectWithArg()
    {
        String joinStatement = "select id, string from " +
                SupportBean.class.getName() + "().win:length(3) as s1, " +
                " method:net.esper.support.eql.SupportStaticMethodLib.fetchObject(string)";
    ...
    public void testInvalid()
    {
        ...
        tryInvalid("select * from SupportBean, method:net.esper.support.eql.SupportStaticMethodLib.fetchObjectAndSleep(1)",
                   "Error starting view: Method footprint does not match the number or type of expression parameters, expecting a method where parameters are typed '[class java.lang.Integer]': Could not find static method named 'fetchObjectAndSleep' in class 'net.esper.support.eql.SupportStaticMethodLib'  [select * from SupportBean, method:net.esper.support.eql.SupportStaticMethodLib.fetchObjectAndSleep(1)]");

        tryInvalid("select * from SupportBean, method:net.esper.support.eql.SupportStaticMethodLib.sleep(100) where 1=2",
        ...
        tryInvalid("select * from SupportBean, method:net.esper.support.eql.SupportStaticMethodLib.dummy where 1=2",
                   "Error starting view: Could not find static method named 'dummy' in class 'net.esper.support.eql.SupportStaticMethodLib' [select * from SupportBean, method:net.esper.support.eql.SupportStaticMethodLib.dummy where 1=2]");

        tryInvalid("select * from SupportBean, method:net.esper.support.eql.SupportStaticMethodLib.minusOne() where 1=2",
                   "Error starting view: Invalid return type for static method 'minusOne' of class 'net.esper.support.eql.SupportStaticMethodLib', expecting a Java class [select * from SupportBean, method:net.esper.support.eql.SupportStaticMethodLib.minusOne() where 1=2]");

        tryInvalid("select * from SupportBean, xyz:net.esper.support.eql.SupportStaticMethodLib.fetchArrayNoArg() where 1=2",
                   "Expecting keyword 'method', found 'xyz' [select * from SupportBean, xyz:net.esper.support.eql.SupportStaticMethodLib.fetchArrayNoArg() where 1=2]");
    }
