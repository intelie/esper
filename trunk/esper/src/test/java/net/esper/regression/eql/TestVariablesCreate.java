...
import net.esper.client.soda.Expressions;
...
public class TestVariablesCreate extends TestCase
{
    ...
    public void testCompile()
    {
        ...
        model = epService.getEPAdministrator().compileEQL(text);
        epService.getEPAdministrator().create(model);
        assertEquals(text, model.toEQL());
    ...
    public void testSubscribeAndIterate()
    {
        ...
        EPStatement stmtCreateOne = epService.getEPAdministrator().createEQL(stmtCreateTextOne);
        ...
        EPStatement stmtCreateTwo = epService.getEPAdministrator().createEQL(stmtCreateTextTwo);
    ...
    public void testDeclarationAndSelect() throws Exception
    {
        ...
        EPStatement stmt = epService.getEPAdministrator().createEQL(buf.toString());
