...
public class TestExprEqualsNode extends TestCase
{
    ...
    public void testValidate() throws Exception
    {
        ...
        equalsNodes[0].addChildNode(new SupportExprNode(String.class));
        equalsNodes[0].validate(null, null, null, null);

        equalsNodes[1].validate(null, null, null, null);
        equalsNodes[2].validate(null, null, null, null);
        equalsNodes[3].validate(null, null, null, null);
