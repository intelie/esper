...
import com.espertech.esper.eql.db.DatabasePollingViewableFactory;
import com.espertech.esper.eql.expression.*;
import com.espertech.esper.eql.join.*;
import com.espertech.esper.eql.join.plan.FilterExprAnalyzer;
import com.espertech.esper.eql.join.plan.QueryGraph;
import com.espertech.esper.eql.join.table.EventTable;
import com.espertech.esper.eql.join.table.PropertyIndTableCoerceAdd;
...
import com.espertech.esper.eql.lookup.*;
import com.espertech.esper.eql.named.*;
import com.espertech.esper.eql.spec.*;
import com.espertech.esper.eql.variable.CreateVariableView;
import com.espertech.esper.eql.variable.OnSetVariableView;
import com.espertech.esper.eql.variable.VariableDeclarationException;
import com.espertech.esper.eql.variable.VariableExistsException;
import com.espertech.esper.eql.view.*;
...
public class EPStatementStartMethod
{
        ...
        throws ExprValidationException, ViewProcessingException
    {
        ...
        services.getNamedWindowService().addProcessor(windowName, windowType, statementContext.getEpStatementHandle(), statementContext.getStatementResultService());
