...
import com.espertech.esper.eql.spec.InsertIntoDesc;
...
public class SelectExprEvalProcessor implements SelectExprProcessor
{
     ...
     * @throws com.espertech.esper.eql.expression.ExprValidationException thrown if any of the expressions don't validate
     */
