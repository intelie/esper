...
/**
 * Represents an equals-for-group (= ANY/ALL/SOME (subselect or expression list)) comparator in a filter expression tree.
 */
public class ExprEqualsGroupNode extends ExprNode
{
     ...
     */
    public ExprEqualsGroupNode(boolean isNotEquals, boolean isAll)
    {
    ...
    {
        if (!(node instanceof ExprEqualsGroupNode))
        {
            return false;
        }

        ExprEqualsGroupNode other = (ExprEqualsGroupNode) node;
