...
public class SelectExprProcessorFactory
{
     ...
     * @throws com.espertech.esper.eql.expression.ExprValidationException to indicate the select expression cannot be validated
     */
     ...
     * @throws com.espertech.esper.eql.expression.ExprValidationException thrown if a name occured more then once
     */
