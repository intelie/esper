...
public class StatementLifecycleSvcImpl implements StatementLifecycleSvc
{
    ...
    protected synchronized EPStatement createStarted(StatementSpec statementSpec, String expression, boolean isPattern, String statementName, String statementId)
    {
    ...
    protected synchronized EPStatementDesc createStopped(StatementSpec statementSpec, String expression, boolean isPattern, String statementName, String statementId)
    {
        ...
        try
        {
            ...
            // create start method
            startMethod = new EPStmtStartMethod(statementId, statementName, statementSpec, expression, services, epStatementHandle);
    ...
    public class EPStatementDesc
    {
        ...
        public EPStatementDesc(EPStatementSPI epStatement, EPStmtStartMethod startMethod, EPStatementStopMethod stopMethod)
        {
