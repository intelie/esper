...
CP="etc:build:patch:classes:lib/esper-2.0.0.jar:lib/commons-logging-1.1.1.jar:lib/cglib-nodep-2.1_3.jar:lib/antlr-runtime-3.0.1.jar:lib/log4j-1.2.15.jar"
