...
public class TestResultSetProcessorFactory extends TestCase
{
    ...
    private LogContextNode<String> statementLogContext;
    ...
    public void setUp()
    {
        ...
        statementLogContext = SupportLogContextNodeFactory.createChild("");
    }
    ...
    public void testGetProcessorNoProcessorRequired() throws Exception
    {
        ...
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(wildcardSelect, null, groupByList, null, null, orderByList, typeService1Stream, eventAdapterService, null, statementLogContext);
    ...
    public void testGetProcessorSimpleSelect() throws Exception
    {
        ...
        List<SelectExprElementUnnamedSpec> wildcardSelect = new LinkedList<SelectExprElementUnnamedSpec>();
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(wildcardSelect, null, groupByList, null, null, orderByList, typeService3Stream, eventAdapterService, null, statementLogContext);
        ...
        processor = ResultSetProcessorFactory.getProcessor(selectList, null, groupByList, null, null, orderByList, typeService1Stream, eventAdapterService, null, statementLogContext);
        assertTrue(processor instanceof ResultSetProcessorSimple);
        ...
        processor = ResultSetProcessorFactory.getProcessor(wildcardSelect, null, groupByList, null, null, orderByList, typeService1Stream, eventAdapterService, null, statementLogContext);
        assertTrue(processor instanceof ResultSetProcessorSimple);
    }
    ...
    public void testGetProcessorAggregatingAll() throws Exception
    {
        ...
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(selectList, null, groupByList, null, null, orderByList, typeService1Stream, eventAdapterService, null, statementLogContext);
    ...
    public void testGetProcessorInvalid() throws Exception
    {
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(SupportSelectExprFactory.makeInvalidSelectList(), null, groupByList, null, null, orderByList, typeService3Stream, eventAdapterService, null, statementLogContext);
            fail();
        }
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(SupportSelectExprFactory.makeNoAggregateSelectListUnnamed(), null, groupByList, null, null, orderByList, typeService3Stream, eventAdapterService, null, statementLogContext);
            fail();
        }
        catch (ExprValidationException ex)
        {
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(selectList, null, groupByList, null, null, orderByList, typeService3Stream, eventAdapterService, null, statementLogContext);
            fail();
        }
        catch (ExprValidationException ex)
        {
