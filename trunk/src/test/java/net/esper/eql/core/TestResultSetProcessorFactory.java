...
public class TestResultSetProcessorFactory extends TestCase
{
    ...
    public void testGetProcessorNoProcessorRequired() throws Exception
    {
        ...
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(new SelectClauseSpec(wildcardSelect), null, groupByList, null, null, orderByList, typeService1Stream, eventAdapterService, null);
    ...
    public void testGetProcessorSimpleSelect() throws Exception
    {
        ...
        List<SelectExprElementUnnamedSpec> wildcardSelect = new LinkedList<SelectExprElementUnnamedSpec>();
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(new SelectClauseSpec(wildcardSelect), null, groupByList, null, null, orderByList, typeService3Stream, eventAdapterService, null);
        ...
        processor = ResultSetProcessorFactory.getProcessor(new SelectClauseSpec(selectList), null, groupByList, null, null, orderByList, typeService1Stream, eventAdapterService, null);
        assertTrue(processor instanceof ResultSetProcessorSimple);
        ...
        processor = ResultSetProcessorFactory.getProcessor(new SelectClauseSpec(wildcardSelect), null, groupByList, null, null, orderByList, typeService1Stream, eventAdapterService, null);
        assertTrue(processor instanceof ResultSetProcessorSimple);
    }
    ...
    public void testGetProcessorAggregatingAll() throws Exception
    {
        ...
        ResultSetProcessor processor = ResultSetProcessorFactory.getProcessor(new SelectClauseSpec(selectList), null, groupByList, null, null, orderByList, typeService1Stream, eventAdapterService, null);
    ...
    public void testGetProcessorInvalid() throws Exception
    {
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(new SelectClauseSpec(SupportSelectExprFactory.makeInvalidSelectList()), null, groupByList, null, null, orderByList, typeService3Stream, eventAdapterService, null);
            fail();
        }
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(new SelectClauseSpec(SupportSelectExprFactory.makeNoAggregateSelectListUnnamed()), null, groupByList, null, null, orderByList, typeService3Stream, eventAdapterService, null);
            fail();
        }
        catch (ExprValidationException ex)
        {
        ...
        try
        {
            ResultSetProcessorFactory.getProcessor(new SelectClauseSpec(selectList), null, groupByList, null, null, orderByList, typeService3Stream, eventAdapterService, null);
            fail();
        }
        catch (ExprValidationException ex)
        {
