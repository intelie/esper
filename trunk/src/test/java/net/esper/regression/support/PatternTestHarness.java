...
{
    private EventCollection sendEventCollection;
    ...
    // Keep a running total of all events received
    ...
    public void runTest() throws Exception
    {
        ...
        // Some listeners may fire as soon as they are started, such as a "not b()" expression for example
