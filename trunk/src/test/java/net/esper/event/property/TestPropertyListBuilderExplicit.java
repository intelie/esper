...
public class TestPropertyListBuilderExplicit extends TestCase
{
    ...
    public void testBuildPropList() throws Exception
    {
        ...
        expected.add(new EventPropertyDescriptor("f_strArr", "f_strArr", SupportLegacyBean.class.getField("fieldStringArray"), EventPropertyType.INDEXED));
        expected.add(new EventPropertyDescriptor("f_strMap", "f_strMap", SupportLegacyBean.class.getField("fieldMapped"), EventPropertyType.MAPPED));
        ...
        expected.add(new EventPropertyDescriptor("m_strArr", "m_strArr", SupportLegacyBean.class.getMethod("readStringArray"), EventPropertyType.INDEXED));
        ...
        expected.add(new EventPropertyDescriptor("m_strMap", "m_strMap", SupportLegacyBean.class.getMethod("readMap"), EventPropertyType.MAPPED));
