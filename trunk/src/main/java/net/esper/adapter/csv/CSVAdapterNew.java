...
public class CSVAdapterNew
{
	 ...
	 */
	public CSVAdapterNew(final EventAdapterService eventAdapterService, final SchedulingService schedulingService, final ScheduleBucket scheduleBucket)
	{
