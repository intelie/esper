...
public class OutputAdapterService
{
    ...
    public OutputAdapterService(String configuration)
    {
    ...
    public JMSAdapter createJMSAdapter2(String adapterName)
    {
        JMSAdapter adapter;
        if (adapterName == null)
        {
    ...
    public JMSAdapter getJMSAdapter2(String outputStreamAlias, String adapterName)
    {
        if (adapterMap == null)
        {
            return null;
