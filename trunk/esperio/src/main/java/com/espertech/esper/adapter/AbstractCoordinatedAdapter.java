...
public abstract class AbstractCoordinatedAdapter implements CoordinatedAdapter
{
	...
	/* (non-Javadoc)
	 * @see com.espertech.esper.adapter.ReadableAdapter#disallowStateChanges()
	 */
	...
	/* (non-Javadoc)
	 * @see com.espertech.esper.adapter.ReadableAdapter#setUsingEngineThread(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.espertech.esper.adapter.CoordinatedAdapter#setScheduleSlot(com.espertech.esper.schedule.ScheduleSlot)
	 */
	...
	/* (non-Javadoc)
	 * @see com.espertech.esper.adapter.CoordinatedAdapter#setEPService(com.espertech.esper.client.EPServiceProvider)
	 */
