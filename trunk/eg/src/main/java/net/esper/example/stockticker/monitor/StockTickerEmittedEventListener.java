...
public class StockTickerEmittedEventListener implements EmittedListener
{
    ...
    private static final Log log = LogFactory.getLog(StockTickerEmittedEventListener.class);
}